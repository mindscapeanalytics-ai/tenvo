...
/**
 * Verified-live Unsplash beauty/nail photography only (HEAD 200).
 * Do not reuse dead IDs from jewelleryCategoryCards lamps/salon fallbacks.
 */
const LIVE = {
  polish: 'https://images.unsplash.com/photo-1604654894610-df63bc536371?w=900&q=85&auto=format&fit=crop',
  gel: 'https://images.unsplash.com/photo-1632345031435-8727f6897d53?w=900&q=85&auto=format&fit=crop',
  manicure: 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=900&q=85&auto=format&fit=crop',
  kit: 'https://images.unsplash.com/photo-1519014816548-bf5fe059798b?w=900&q=85&auto=format&fit=crop',
  press: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=900&q=85&auto=format&fit=crop',
  care: 'https://images.unsplash.com/photo-1556228720-195a672e8a03?w=900&q=85&auto=format&fit=crop',
  cream: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=900&q=85&auto=format&fit=crop',
  balm: 'https://images.unsplash.com/photo-1596755389378-c31d21fd1273?w=900&q=85&auto=format&fit=crop',
  tools: 'https://images.unsplash.com/photo-1583209814683-c023dd293cc6?w=900&q=85&auto=format&fit=crop',
  makeup: 'https://images.unsplash.com/photo-1512496015851-a90fb38ba796?w=900&q=85&auto=format&fit=crop',
  beauty: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=900&q=85&auto=format&fit=crop',
  soft: 'https://images.unsplash.com/photo-1526045478516-99145907023c?w=900&q=85&auto=format&fit=crop',
  glow: 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=900&q=85&auto=format&fit=crop',
};

const PRODUCT_IMAGES = {
  polish1: LIVE.polish,
  polish2: LIVE.gel,
  polish3: LIVE.manicure,
  polish4: LIVE.kit,
  polish5: LIVE.soft,
  polish6: LIVE.beauty,
  polish7: LIVE.makeup,
  ...
  polish10: LIVE.press,
  polish11: LIVE.gel,
  polish12: LIVE.manicure,
  press1: LIVE.press,
  press2: LIVE.polish,
  press3: LIVE.kit,
  press4: LIVE.beauty,
  press5: LIVE.manicure,
  press6: LIVE.glow,
  press7: LIVE.care,
  press8: LIVE.soft,
  kit1: LIVE.kit,
...
function pickHeroCandidates(oliveMedia, bestMedia) {
  ...
  // Prefer true hero/lifestyle frames over logo/CTA crops.
  const ranked = uniqUrls([
    ...prefer(oliveMedia, /Hero-Desktop/i),
    ...prefer(oliveMedia, /summer-vibes-poster/i),
    ...prefer(bestMedia, /main_page/i),
    ...prefer(oliveMedia, /Pedi-Web-Banner-Desktop|Background-Desktop|Heading-Desktop/i),
    ...prefer(oliveMedia, /Hero-Mobile|summer/i),
    ...oliveMedia.slice(0, 12),
    ...bestMedia.slice(0, 6),
  ]);
  return ranked;
}
