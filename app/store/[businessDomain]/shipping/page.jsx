        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
            ...
            <p className="text-gray-600">
              Enjoy free standard shipping on all orders over <strong>Rs. {freeShippingThreshold.toLocaleString()}</strong>. No promo code needed — the discount is applied automatically at checkout.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
            ...
            <div className="space-y-3">
              {[
                { name: 'Standard Delivery', time: '3–5 business days', price: `Free on orders over Rs. ${freeShippingThreshold.toLocaleString()}, otherwise Rs. 150` },
                { name: 'Express Delivery', time: '1–2 business days', price: 'Rs. 300' },
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
            ...
            <p className="text-gray-600 mb-3">
              Once your order is dispatched you'll receive a confirmation. You can track your order status anytime from the Order History page.
            </p>
            <Link
