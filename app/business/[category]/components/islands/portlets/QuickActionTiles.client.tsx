...
export const QuickActionTiles = memo(function QuickActionTiles({
    ...
    const actions = [
        ...
        { id: transferAction, label: 'Stock Transfer', icon: ArrowLeftRight, color: 'bg-[#edc75c] text-neutral-900', hover: 'hover:bg-[#c49c3b]', desc: multiLocationEnabled ? 'Inter-branch' : 'Procurement' },
        ...
        { id: 'new-product', label: 'New Product', icon: PlusCircle, color: 'bg-[#edc75c] text-neutral-900', hover: 'hover:bg-[#c49c3b]', desc: 'Entry & Catalog' },
        campaignEnabled
