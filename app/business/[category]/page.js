  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full mt-2">
        ...
        >
          <TabsList className="bg-gray-100/50 p-1 rounded-xl w-full flex overflow-x-auto hide-scrollbar">
            <TabsTrigger value="dashboard" className="rounded-lg gap-2 min-w-fit flex-1">
              <LayoutDashboard className="w-4 h-4" />
              <span>Overview</span>
            </TabsTrigger>

            <TabsTrigger value="invoices" className="rounded-lg gap-2 min-w-fit flex-1">
              <FileText className="w-4 h-4" />
              <span>Sales</span>
            </TabsTrigger>

            <TabsTrigger value="inventory" className="rounded-lg gap-2 min-w-fit flex-1">
              <PackageIcon className="w-4 h-4" />
              <span>Inventory</span>
            </TabsTrigger>

            <TabsTrigger value="customers" className="rounded-lg gap-2 min-w-fit flex-1">
              <UsersIcon className="w-4 h-4" />
              <span>Customers</span>
            </TabsTrigger>

            <TabsTrigger value="vendors" className="rounded-lg gap-2 min-w-fit flex-1">
              <Truck className="w-4 h-4" />
              <span>Vendors</span>
            </TabsTrigger>

            <TabsTrigger value="purchases" className="rounded-lg gap-2 min-w-fit flex-1">
              <ShoppingCart className="w-4 h-4" />
              <span>Purchase</span>
            </TabsTrigger>

            <TabsTrigger value="sales" className="rounded-lg gap-2 min-w-fit flex-1">
              <TrendingUp className="w-4 h-4" />
              <span>Sales</span>
            </TabsTrigger>

            {domainKnowledge?.manufacturingEnabled && (
              <TabsTrigger value="manufacturing" className="rounded-lg gap-2 min-w-fit flex-1">
            ...
            {domainKnowledge?.multiLocationEnabled && (
              <TabsTrigger value="warehouses" className="rounded-lg gap-2 min-w-fit flex-1">
                <Warehouse className="w-4 h-4" />
                <span>Warehouses</span>
              </TabsTrigger>
            )}

            <TabsTrigger value="accounting" className="rounded-lg gap-2 min-w-fit flex-1">
              <Building2 className="w-4 h-4" />
              <span>Accounting</span>
            </TabsTrigger>

            <TabsTrigger value="reports" className="rounded-lg gap-2 min-w-fit flex-1">
              <BarChart3 className="w-4 h-4" />
              <span>Analytics</span>
            </TabsTrigger>

            <TabsTrigger value="finance" className="rounded-lg gap-2 min-w-fit flex-1">
              <DollarIcon className="w-4 h-4" />
              <span>Finance</span>
            </TabsTrigger>

            <TabsTrigger value="gst" className="rounded-lg gap-2 min-w-fit flex-1">
              <Hash className="w-4 h-4" />
              <span>Tax/GST</span>
            </TabsTrigger>

            <TabsTrigger value="payments" className="rounded-lg gap-2 min-w-fit flex-1">
              <DollarSign className="w-4 h-4" />
              <span>Payments</span>
            </TabsTrigger>

            {domainKnowledge?.inventoryFeatures?.includes('Quotation Management') && (
              <TabsTrigger value="quotations" className="rounded-lg gap-2 min-w-fit flex-1">
            ...
            {['owner', 'admin'].includes(role) && (
              <TabsTrigger value="settings" className="rounded-lg gap-2 min-w-fit flex-1">
