...
/**
 * Premium screen-aware pharmacy homepage hero (~full viewport).
 */
    ...
    <section className="relative bg-white">
      ...
      <div className="relative z-20 mx-auto hidden max-w-[1400px] px-4 sm:px-6 lg:block lg:px-8">
        <div className="-mt-16 xl:-mt-[4.5rem]">
          <div className="rounded-2xl border border-emerald-100/80 bg-white/95 p-4 shadow-xl shadow-emerald-900/10 backdrop-blur-sm sm:p-5">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
              ...
              <div className="flex min-w-0 flex-1 flex-col gap-2 sm:flex-row">
                <div className="relative min-w-0 flex-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-white py-3 pl-10 pr-4 text-sm text-slate-900 outline-none transition focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100"
              ...
              <Link
                ...
                className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl border border-emerald-600 px-4 py-3 text-xs font-semibold text-emerald-700 transition hover:bg-emerald-50"
              >
