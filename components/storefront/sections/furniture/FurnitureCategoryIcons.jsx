...
function CategoryTile({ cat }) {
  return (
    ...
    >
      <div
        className={cn(
          'relative h-14 w-14 overflow-hidden rounded-full border border-amber-100 bg-amber-50/60 shadow-sm',
          'transition duration-300 motion-safe:group-hover:scale-105 motion-safe:group-hover:border-amber-300 motion-safe:group-hover:shadow-md',
...
/**
 * Furniture "Shop by category" — single-row auto-scroll marquee on all breakpoints
 * (shared StoreMarqueeRow pattern used by pharmacy / supermarket / restaurant).
 */
export function FurnitureCategoryIcons({ categoryIcons = [] }) {
...
export default FurnitureCategoryIcons;
