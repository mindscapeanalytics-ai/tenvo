              ...
              {suggestions.map((product, index) => (
                ...
                >
                  ...
                  <div className="relative w-14 h-14 bg-gray-100 rounded-lg overflow-hidden flex-shrink-0">
                    <SmartProductImage
                      src={product.image_url || product.images?.[0]?.url || getEffectiveProductImageUrl(product, business?.category)}
                      alt={product.name}
                      fill
                      imageVariant="thumb"
                      fallbackSrc={getEffectiveProductImageUrl(product, business?.category)}
