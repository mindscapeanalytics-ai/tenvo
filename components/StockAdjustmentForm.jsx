...
const ADJUSTMENT_REASONS = [
    ...
    { value: 'sample', label: 'Sample / Testing', icon: '🧪', color: 'bg-purple-100 text-purple-700' },
    ...
    { value: 'opening', label: 'Opening Balance', icon: '📊', color: 'bg-indigo-100 text-indigo-700' },
