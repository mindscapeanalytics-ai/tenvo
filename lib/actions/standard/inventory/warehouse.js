...
import { checkPlanFeature, checkPlanLimit } from '@/lib/auth/planGuard';

async function checkAuthAndPlan(businessId, featureKey = null) {
...
export async function getWarehouseLocationsAction(businessId) {
    try {
        await checkAuthAndPlan(businessId, 'multi_warehouse');
...
export async function createWarehouseLocationAction(locationData) {
    try {
        await checkAuthAndPlan(locationData.business_id, 'multi_warehouse');
