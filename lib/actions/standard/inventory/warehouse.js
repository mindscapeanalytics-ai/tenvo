...
async function checkAuthAndPlan(businessId, permission = 'warehouses.view', feature = 'multi_warehouse') {
    // Trusted bypass (hub shell after withGuard) skips plan feature so free-tier hubs still paint locations.
 ...
 * @param {object} [options] - Reserved for future filters (client skipAuth is ignored)
 */
