...
async function checkAuth(businessId, client = null, permission = 'inventory.view', options = {}) {
...
export async function getProductsAction(businessId, options = {}) {
    try {
        const { skipAuth = false, ...productOptions } = options;
        await checkAuth(businessId, null, 'inventory.view', { skipAuth });
