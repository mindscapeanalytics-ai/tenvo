...
async function checkAuth(businessId, client = null, permission = 'dashboard.view') {
 ...
 * @param {object} [options] - Reserved (client skipAuth is ignored; use runWithTrustedAuthBypass)
 */
export async function getUnifiedActivityFeedAction(businessId, limit = 10, options = {}) {
    try {
        void options;
        const client = await pool.connect();
        try {
            await checkAuth(businessId, client, 'dashboard.view');
