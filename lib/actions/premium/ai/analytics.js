...
export async function getAnalyticsBundleAction(businessId, filter = {}) {
    ...
    try {
        ...
        try {
            ...
            const salesTrend = await fetchSalesTrendRows(client, businessId, {
                from: range.from,
                to: range.to,
                channel,
                category,
            ...
            const topRes = await client.query(TOP_MOVING_PRODUCTS_SQL, [
                businessId,
                5,
                range.from,
                range.to,
            ...
            const categoriesRes = await client.query(SALES_PRODUCT_CATEGORIES_SQL, [businessId]);
