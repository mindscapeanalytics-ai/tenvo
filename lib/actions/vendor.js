 ...
 * @returns {Promise<{success: boolean, vendor?: any, error?: string}>}
 */
...
export async function updateVendorAction(businessId, vendorId, updates) {
    try {
        ...
        try {
            ...
            const validColumns = ['name', 'email', 'phone', 'contact_person', 'ntn', 'srn', 'address', 'city', 'state', 'payment_terms', 'credit_limit', 'outstanding_balance', 'domain_data', 'filer_status', 'opening_balance'];
