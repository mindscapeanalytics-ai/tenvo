  ...
  try {
    ...
    try {
      ...
      if (
        ...
        console.warn('[getBusinessByDomain] Categories query skipped:', categoriesError.message);
    ...
    return actionSuccess({
      ...
      settings: {
        ...rawSettingsEarly,
        currency: rawSettingsEarly.currency || 'PKR',
        locale: rawSettingsEarly.locale || 'en-PK',
