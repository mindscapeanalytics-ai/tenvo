-- Idempotent: create corrected invoice_aging view (balance-based, exclusive buckets).
-- Same as prisma/migrations/20260718_invoice_aging_view/migration.sql
-- Prefer: bun run db:migrate
-- Manual: psql $DATABASE_URL -f lib/db/migrations/048_invoice_aging_view.sql
