...
} from '../storefront/marinePartsArchiveMap.js';
...
import { getSupermarketFamilyProfileExtras } from './supermarketArchiveSeed.js';
...
const BY_DOMAIN_KEY = {
  ...
  'textile-wholesale': {
    description:
      'Jama Cloth fabric wholesale — lawn, cotton, khaddar, and suit lots for retailers and boutiques.',
    city: 'Lahore',
    address: 'Jama Cloth Market, Outside Lohari Gate',
    businessHours: 'Mon - Sat, 10:00 AM - 8:00 PM',
    freeShippingThreshold: 15000,
    returnPolicyDays: 3,
    announcement: 'Wholesale thaan & suit packs · MOQ-friendly lots · Bulk orders welcome',
    accentColor: '#111827',
  },
  'retail-shop': {
  ...
  restaurant: {
    description:
      'Experience the essence of Desi flavours at Roll Inn in Karachi. Hearty BBQ, rolls, biryani, and combos made with tradition and taste.',
    city: 'Karachi',
    address: 'Karachi',
    businessHours: 'Daily, 12:00 PM - 1:00 AM',
    freeShippingThreshold: 1500,
    returnPolicyDays: 0,
    announcement: 'Order online · Delivery & takeaway · Dine-in',
    accentColor: '#dc2626',
    storefront: {
      restaurant: {
        showTrustStrip: true,
        showUpperPromoTiles: false,
  ...
  supermarket: {
    description:
      'Tenvo Supermarket — Clifton-style online grocery with fresh produce, mega food & non-food offers, pharmacy, and household essentials. Delivery across Karachi.',
    city: 'Karachi',
    address: 'Clifton, Block 5',
    businessHours: 'Daily, 10:00 AM - 9:00 PM',
    freeShippingThreshold: 3000,
    returnPolicyDays: 3,
    announcement: 'Delivery 10 AM – 9 PM · Free delivery on larger baskets',
    keywords: 'supermarket, grocery, fresh produce, beverages, household, Karachi, online shopping',
    ...getSupermarketFamilyProfileExtras(),
  },
  'hardware-store': {
  ...
  'marine-parts': {
    ...
    city: 'Gendt',
    address: 'Biezenkamp 1, 6691 EJ Gendt',
    phone: '+31 26 845 1200',
    email: 'parts@tenvomarine.com',
    whatsapp: '+31 26 845 1200',
  ...
  sgcarmart: {
    description:
      'Singapore\'s #1 car platform demo — new, used, and rental listings, e-shop parts, valuations, and motoring resources.',
    city: 'Singapore',
    address: 'Ubi Techpark',
    businessHours: 'Mon - Sun, 8:00 AM - 10:00 PM',
    freeShippingThreshold: 100,
    returnPolicyDays: 7,
    announcement: 'Singapore Motor Carnival 2026 — explore listings, promotions, and e-shop accessories',
    accentColor: '#E30613',
    cover_image_url:
      'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=1920&q=85&auto=format&fit=crop',
    storefront: {
      marketplace: {
        heroPromo: {
          eyebrow: 'Singapore Motor Carnival 2026',
          title: 'Singapore\'s #1 car platform for new & used cars',
          subtitle:
            'Search thousands of listings, new launches, used bargains, rentals, and e-shop accessories.',
  ...
  'milk-shop': {
    description:
      'Fresh cow and buffalo milk by the kg, homemade dahi, makkhan, lassi, and packaged dairy — chilled daily.',
    city: 'Karachi',
    address: 'Saddar, Near Empress Market',
    businessHours: 'Daily, 6:00 AM - 10:00 PM',
    freeShippingThreshold: 1500,
    returnPolicyDays: 0,
    announcement: 'Fresh milk by kg · Morning chilled delivery',
    keywords: 'milk shop, doodh, dahi, lassi, paneer, ghee, Pakistan, Karachi',
    accentColor: '#0ea5e9',
    cover_image_url: buildUnsplashImageUrl('1563636619-e9143da7973b', { w: 1200 }),
  },
  'water-delivery': {
    description:
      'Crystal clear mineral water delivered to your door — 19L and 12L refills, dispensers, PET cases, and weekly rider routes across Pakistan.',
    city: 'Karachi',
    address: 'DHA Phase 6, Korangi Industrial Area plant + city riders',
    businessHours: 'Daily, 8:00 AM - 8:00 PM',
    freeShippingThreshold: 2000,
    returnPolicyDays: 0,
    announcement: 'Home delivery · Fixed rider days · Empty bottle return',
    keywords:
      'water delivery, 19 litre, mineral water, dispenser, Karachi, DHA, Bahria Town, bottled water Pakistan',
    accentColor: '#0284c7',
    cover_image_url: buildUnsplashImageUrl('1548832330-d0f21f4b8f8b', { w: 1200 }),
    phone: '021-111-836-868',
    email: 'hello@tenvo.store',
  },
  boutique: {
  ...
  electronics: {
    description: 'Home appliances, LED TVs, and gadgets with official warranty and installment enquiry support.',
    city: 'Karachi',
    address: 'Karachi',
    businessHours: 'Mon - Sat, 10:00 AM - 9:00 PM',
    freeShippingThreshold: 5000,
    returnPolicyDays: 7,
    announcement: 'Genuine warranty · Installment enquiry · Karachi delivery',
    accentColor: '#2563eb',
  },
  'electronics-goods': {
    description: 'Home appliances, LED TVs, and gadgets with official warranty and installment enquiry support.',
  ...
  'ceramics-tiles': {
    description:
      'Tenvo Marbles offers porcelain and ceramic tile collections plus marble, granite, onyx, and natural stone slabs for homes and commercial projects across Pakistan.',
    city: 'Karachi',
    address: 'Main Shahrah-e-Faisal, Tile & Marble Market',
    phone: '021 3456 7800',
    businessHours: 'Mon - Sat, 10:00 AM - 8:00 PM',
    freeShippingThreshold: 25000,
    returnPolicyDays: 7,
    announcement: 'Shade-matched lots · Porcelain collections · Marble & onyx slabs',
    accentColor: '#1c1917',
  },
  jewellery: {
    description:
  ...
  fmcg: {
    description:
      'Fast-moving consumer goods, household, personal care, and pantry staples — wholesale and retail with distributor pricing.',
    city: 'Faisalabad',
    ...
    keywords: 'fmcg, grocery, household, personal care, pantry staples, wholesale, Pakistan',
    ...getSupermarketFamilyProfileExtras(),
  },
  'dairy-farm': {
    description:
      'Fresh dairy, milk products, and farm essentials — delivered from farm to your doorstep.',
    city: 'Sahiwal',
    address: 'Dairy Farm Road',
    businessHours: 'Daily, 6:00 AM - 8:00 PM',
    freeShippingThreshold: 2500,
    returnPolicyDays: 2,
    announcement: 'Fresh daily · Farm-direct delivery',
    keywords: 'dairy, milk, yogurt, cheese, farm fresh, Pakistan',
    ...getSupermarketFamilyProfileExtras(),
  },
  'poultry-farm': {
    description:
      'Fresh poultry, eggs, and farm produce — hygienically packed and delivered fast.',
    city: 'Multan',
    address: 'Poultry Farm Zone',
    businessHours: 'Daily, 7:00 AM - 7:00 PM',
    freeShippingThreshold: 2500,
    returnPolicyDays: 2,
    announcement: 'Farm-fresh eggs & poultry · Same-day delivery in service area',
    keywords: 'poultry, eggs, chicken, farm fresh, Pakistan',
    ...getSupermarketFamilyProfileExtras(),
  },
  'livestock-cattle': {
    description:
      'Livestock supplies, feed, and farm essentials for cattle and pastoral operations.',
    city: 'Bahawalpur',
    address: 'Livestock Market Road',
    businessHours: 'Mon - Sat, 7:00 AM - 6:00 PM',
    freeShippingThreshold: 5000,
    returnPolicyDays: 3,
    announcement: 'Feed & farm supplies · Bulk orders welcome',
    keywords: 'livestock, cattle, feed, farm supplies, Pakistan',
    ...getSupermarketFamilyProfileExtras(),
  },
  'solar-energy': {
  ...
  'leather-footwear': {
    description:
      'Shop authentic local and imported footwear — men, women, kids, sports, and orthopedic — with size-first search and graded condition.',
    city: 'Karachi',
    address: 'Zamzama Commercial Lane',
    businessHours: 'Mon - Sun, 11:00 AM - 9:00 PM',
    freeShippingThreshold: 3500,
    returnPolicyDays: 14,
    announcement: 'Local + imported brands · Size finder · Free exchanges',
    accentColor: '#FFDA00',
    keywords:
      'shoes, footwear, sneakers, Nike, Adidas, Bata, sports shoes, running, Pakistan',
    storefront: {
      footwear: {
        showSaleHero: true,
        showPromoStrip: true,
...
export function getDemoStorefrontProfile(domainKey, regional = {}, businessName = '') {
  ...
  return {
    ...
    contact: {
      ...
      whatsapp: base.whatsapp || base.phone || null,
      published: true,
    },
  };
}
