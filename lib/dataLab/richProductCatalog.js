...
import { TILES_SEED_PRODUCTS } from './tilesDemoCatalog.js';
import { TYRE_SEED_PRODUCTS } from './tyreDemoCatalog.js';
import { FOOTWEAR_SEED_PRODUCTS } from './footwearDemoCatalog.js';
import { MILK_SHOP_SEED_PRODUCTS } from './milkShopDemoCatalog.js';
import { WATER_SHOP_SEED_PRODUCTS } from './waterShopDemoCatalog.js';
import { ELECTRONICS_SEED_PRODUCTS } from './electronicsDemoCatalog.js';
import { RESTAURANT_SEED_PRODUCTS } from './restaurantDemoCatalog.js';
import { AUTO_PARTS_SEED_CATALOG } from './autopartsSeedCatalog.js';
import { MARINE_PARTS_SEED_CATALOG } from './marinePartsSeedCatalog.js';
...
export const RICH_PRODUCT_CATALOG = {
  ...
  'textile-wholesale': [
    {
      ...
      domain_data: { fabrictype: 'Lawn', korafinished: 'Printed', articleno: 'GA-101', sourcing: 'local' },
      is_featured: true,
    },
    {
      ...
      image_url: stockImage('1594938298603-c8148c4dae35'),
      domain_data: { fabrictype: 'Cotton', korafinished: 'Finished', sourcing: 'local' },
    },
    {
      ...
      domain_data: { thaanlength: 40, fabrictype: 'Khaddar', sourcing: 'local' },
    },
    {
    ...
    },
    {
      ...
      domain_data: { fabrictype: 'Chiffon', korafinished: 'Embroidered', sourcing: 'local' },
    },
    {
      ...
      image_url: stockImage('1617137968427-85924c800a22'),
      domain_data: { fabrictype: 'Wash & Wear', korafinished: 'Finished', sourcing: 'local' },
    },
    {
      ...
      domain_data: { thaanlength: 35, fabrictype: 'Cotton', sourcing: 'local' },
    },
    {
  ...
  'retail-shop': [
    ...
    },
    {
      ...
      stock: 35,
      sku: 'RTL-WLT-002',
      image_url: stockImage('1618221195710-dd6b41faaea6'),
    },
    {
  ...
  'ceramics-tiles': TILES_SEED_PRODUCTS,
  'tyre-shop': TYRE_SEED_PRODUCTS,
  'leather-footwear': FOOTWEAR_SEED_PRODUCTS,
  'milk-shop': MILK_SHOP_SEED_PRODUCTS,
  'water-delivery': WATER_SHOP_SEED_PRODUCTS,
  'electronics-goods': ELECTRONICS_SEED_PRODUCTS,
  electronics: ELECTRONICS_SEED_PRODUCTS,
  ...
  'marine-parts': MARINE_PARTS_SEED_CATALOG,
  ...
  'hardware-sanitary': [
    ...
    },
    {
      ...
      stock: 8,
      sku: 'HW-GRH-MIX',
      image_url: stockImage('1581092918056-0c4c3acd3789'),
    },
    {
