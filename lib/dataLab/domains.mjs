...
export const DEMO_BUSINESS_PACK = [
  ...
  { key: 'restaurant', name: 'Roll Inn', domain: 'demo-restaurant', country: 'Pakistan', fullSeed: true },
...
export const DEMO_SHOWCASE_PACK = [
  ...
  { key: 'boutique', name: 'Tenvo Boutique Demo', domain: 'demo-boutique', country: 'Pakistan', fullSeed: true, showcase: true },
  { key: 'gems-jewellery', name: 'Tenvo Jewellery Demo', domain: 'demo-jewellery', country: 'Pakistan', fullSeed: false, showcase: true },
  { key: 'electronics-goods', name: 'Tenvo Electronics', domain: 'demo-electronics', country: 'Pakistan', fullSeed: true, showcase: true },
  ...
  { key: 'ceramics-tiles', name: 'Tenvo Marbles', domain: 'demo-marbles', country: 'Pakistan', fullSeed: true, showcase: true },
  { key: 'tyre-shop', name: 'Tenvo Tyre Store', domain: 'demo-tyre', country: 'Pakistan', fullSeed: true, showcase: true },
  { key: 'milk-shop', name: 'Tenvo Milk Demo', domain: 'demo-milk', country: 'Pakistan', fullSeed: true, showcase: true },
  { key: 'water-delivery', name: 'Tenvo Water Supply', domain: 'demo-water', country: 'Pakistan', fullSeed: true, showcase: true },
  ...
  { key: 'leather-footwear', name: 'Tenvo Footwear Demo', domain: 'demo-footwear', country: 'Pakistan', fullSeed: true, showcase: true },
  { key: 'gym-fitness', name: 'Tenvo Fitness Demo', domain: 'demo-fitness', country: 'Pakistan', fullSeed: true, showcase: true },
  { key: 'marine-parts', name: 'Tenvo Marine', domain: 'demo-marine', country: 'Netherlands', fullSeed: true, showcase: true },
];
