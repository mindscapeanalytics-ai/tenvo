...
import { getRegionalStandardsForBusiness } from '@/lib/utils/businessRegionalContext';
...
export function BusinessProvider({ children }) {
    ...
    useEffect(() => {
        if (typeof window !== 'undefined') {
            ...
            // Only restore safe, non-sensitive display fields
            ...
            if (storedBiz) {
                try {
                    ...
                    // Strip any fields that could be spoofed to affect UI gating
                    // plan_tier and role are re-fetched from server on every sync
