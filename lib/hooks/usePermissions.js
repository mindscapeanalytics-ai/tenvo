...
export function usePermissions() {
    ...
    const helpers = useMemo(() => ({
         ...
         * @returns {boolean}
         */
        planCan: (featureKey) => planHasFeatureWithPackaging(planTier, featureKey, businessSettings, platformOverrides),
         ...
         */
        isLocked: (featureKey) => {
            const enabled = planHasFeatureWithPackaging(planTier, featureKey, businessSettings, platformOverrides);
            return {
                locked: !enabled,
        ...
        planTier,
        moduleAccess,
    }), [effectiveRole, planTier, businessSettings, platformOverrides, moduleAccess]);
