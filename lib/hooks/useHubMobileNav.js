...
import { isCampaignRelevant, isHospitality, isPosRelevant } from '@/lib/config/domains';
...
export function useHubMobileNav() {
  ...
  const ctx = useMemo(
    ...
    [category, domainKnowledge, posRelevant, hospitalityDomain, campaignRelevant, effectiveRole, planTier, business?.settings]
  );
