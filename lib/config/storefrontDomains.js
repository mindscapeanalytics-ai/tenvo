...
export const STOREFRONT_DOMAIN_CONFIG = {
  'retail-shop': {
    ...
    bannerText: 'Free shipping on orders over Rs. 2,000',
  },
  ...
  'restaurant-cafe': {
    ...
    bannerText: '🍽️ Free delivery on orders over Rs. 1,500',
  },
  ...
  'fashion-clothing': {
    ...
    trustBadges: [
      ...
      { icon: 'truck', title: 'Free Shipping', subtitle: 'On orders over Rs. 3,000' },
...
export function getDomainConfig(category) {
  return STOREFRONT_DOMAIN_CONFIG[category] || STOREFRONT_DOMAIN_CONFIG.default;
}
