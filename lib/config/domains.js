...
export const MANUFACTURING_DOMAINS = new Set([
    'garments', 'textile-mills', 'steel-metal', 'leather-goods',
    'flour-mills', 'oil-ghee', 'marble-granite', 'packaging',
    'furniture-wood', 'glass-ceramics', 'plastic', 'chemicals-paint',
    'rice-mills', 'bakery-confectionery'
]);
