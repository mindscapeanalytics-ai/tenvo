...
export const DOMAIN_PACKAGES = Object.freeze({
  ...
  'milk-commerce': {
    ...
    tagline: 'Counter kg POS, Route Hisab, and chill FEFO without ERP clutter',
    summary:
      'Built for Pakistani neighborhood doodh shops selling fresh milk by kg, dahi and pack dairy at the counter, and morning house routes on paper-style hisab. SuperStore POS with weight lines, elevated milk storefront, FEFO chill stock, and weekly or monthly credit collect on the same invoices and AR as the rest of Tenvo. No restaurant, warehouse chain, or membership chrome.',
    verticals: ['milk-shop'],
