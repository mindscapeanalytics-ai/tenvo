...
export const DOMAIN_PACKAGES = Object.freeze({
  ...
  'water-commerce': {
    ...
    tagline: 'City and area routes, 19L refill, domestic and corporate collect in one rider OS',
    summary:
      'Built for Pakistani bottled water suppliers: register houses and offices by city and area, run daily rider sheets with weekday delivery days, track empty bottle deposits, and collect weekly or monthly credit. Same stock and AR as your counter POS. No restaurant, warehouse chain, or membership chrome.',
    ...
    moduleGroups: [
      {
        ...
        body:
          'Customer book with city, delivery area (Karachi DHA, Gulshan, Clifton, and other cities), rider/route, and weekday cadence for domestic and corporate accounts.',
        bullets: [
      ...
      },
      {
        ...
        title: 'Counter POS',
        body:
          'Walk-in and corporate pickup on SuperStore POS with barcode and refunds. Same tenant stock as the route sheet.',
        bullets: [
          'SuperStore POS shell',
          'Barcode for sealed packs',
          'Credit notes for deposit returns',
        ],
        status: 'shipped',
      },
    ],
    faqs: [
      {
        ...
        answer:
          'Same idea (daily sheet + period bills), different vertical. water-delivery has its own tables, bottle fields, city/area knowledge, and weekday delivery days. It does not use milk kg or dairy brands.',
      },
      {
        question: 'How do I register this suite?',
        answer:
          'Open Industry Plans → Water delivery, or go to /solutions/water-commerce and choose Get this suite. Registration uses package=water-commerce, domain=water-delivery, and the Professional plan with lean packaging applied.',
      },
      {
        question: 'Does Daily Route need a higher plan?',
        answer:
          'Daily Route is domain-gated for water-delivery tenants. The suite recommends Professional so reports and credit notes sit next to counter and routes without Business bloat.',
      },
    ],
    competitorNotes: [
      'Spreadsheet route books lose weekday schedules and deposit tracking.',
      'Generic delivery apps do not settle weekly water credit into AR invoices.',
      'Tenvo keeps rider sheet, bottle stock, and collect on one tenant without restaurant chrome.',
    ],
  },
});
