...
import {
  ...
  MILK_COMMERCE_FEATURE_OVERRIDES,
  WATER_COMMERCE_FEATURE_OVERRIDES,
...
export const DOMAIN_PACKAGES = Object.freeze({
  ...
  'milk-commerce': {
    key: 'milk-commerce',
    slug: 'milk-commerce',
    name: 'Milk Shop Commerce Suite',
    tagline: 'kg counter, Route Hisab, chill FEFO, and credit collect in one doodh-shop OS',
    summary:
      'Built for Pakistani neighborhood milk shops: sell fresh milk by kg at the counter, run morning house routes on Route Hisab, keep chill dairy on FEFO, and collect weekly or monthly credit with bilingual thermal bills. Same stock and AR as your online milk store. No restaurant, warehouse chain, or membership chrome.',
    verticals: ['milk-shop'],
    defaultVertical: 'milk-shop',
    ...
    packaging: {
      mode: 'custom',
      feature_overrides: { ...MILK_COMMERCE_FEATURE_OVERRIDES },
    },
    pricing: {
      price_pkr: 10000,
      price_usd: 35,
      billing: 'monthly',
      badge: 'Milk shop suite',
    },
    marketingPath: '/solutions/milk-commerce',
    demoStoreDomain: 'demo-milk',
    moduleGroups: [
      {
        id: 'counter',
        title: 'Counter POS (kg)',
        body:
          'Walk-in fresh milk by kg, pack dairy by barcode, refunds, and offline queue for load-shedding. Same SuperStore shell used by grocery counters, tuned for weight lines.',
        bullets: [
          'Weight-aware SuperStore POS',
          'Barcode for packaged dairy',
          'Offline POS mode for power cuts',
        ],
        status: 'shipped',
      },
      {
        ...
        title: 'Route Hisab',
        body:
          'Morning doorstep sheet by house number and route. Week or month totals become invoices and receipts on the standard AR path, with 58mm thermal hisab bills and reminders.',
        bullets: [
          'Daily route grid for active houses',
          'Week/month invoice from delivery totals',
          'Thermal bills plus hub/email/WhatsApp reminders',
        ],
        status: 'shipped',
      },
      {
        id: 'chill',
        title: 'Chill inventory (FEFO)',
        body:
          'Best-before and batch tracking for chilled and packaged dairy. Dairy field presets (milk type, fat %, chilled) without farm livestock fields.',
        bullets: [
          'FEFO and near-expiry awareness',
          'Batch tracking on Professional packaging',
          'kg-first units and PK dairy brands',
        ],
        status: 'shipped',
      },
      {
        ...
        body:
          'Elevated supermarket-family storefront with milk overlays, category rails, and storefront orders fulfilled in the hub. Decimal kg qty on weight SKUs only.',
        bullets: [
          'demo-milk style public store',
          'Storefront orders in hub',
          'JazzCash, Easypaisa, COD friendly checkout',
        ],
        status: 'shipped',
      },
    ],
    faqs: [
      {
        question: 'Is this the same as a supermarket or dairy farm package?',
        answer:
          'No. milk-commerce is only for milk-shop (and aliases like doodh-shop). Supermarket grocery aisles and dairy-farm livestock stay on their own verticals.',
      },
      {
        question: 'How do I register this suite?',
        answer:
          'Open Industry Plans → Milk shop, or go to /solutions/milk-commerce and choose Get this suite. Registration uses package=milk-commerce, domain=milk-shop, and the Professional plan with lean packaging applied.',
      },
      {
        question: 'Does Route Hisab need a higher plan?',
        answer:
          'Route Hisab is domain-gated for milk-shop tenants. The suite recommends Professional so batch/FEFO and solid reports sit next to counter and hisab without Business bloat.',
      },
      {
        question: 'Can I add a second chill room later?',
        answer:
          'Default is one location. Owners can re-enable multi-location via Settings Industry overrides and packaging if the shop grows. Neighborhood doodh shops usually stay single-counter.',
      },
      {
        question: 'Will this help me sell more milk with the same staff?',
        answer:
          'Yes for throughput and collection: faster kg POS at the counter, one morning sheet instead of paper registers, bilingual bills that reduce credit disputes, and offline modes so load-shedding does not stop the day. Stock and AR stay unified so you spend less time reconciling and more time serving houses.',
      },
    ],
    competitorNotes: [
      'Generic ERPs bury route hisab under warehouse and CRM modules keepers never use.',
      'Delivery apps sell orders but not morning house registers and monthly credit collect.',
      'Tenvo keeps counter, hisab, chill stock, and online milk on one tenant without restaurant or gym chrome.',
    ],
  },
  ...
  'water-commerce': {
    key: 'water-commerce',
    slug: 'water-commerce',
    name: 'Water Delivery Commerce Suite',
    tagline: 'City & area routes, 19L refills, domestic & corporate collect, and expense tracking in one lean OS',
    summary:
      'Built for Pakistani bottled water suppliers: register houses and offices by city and area, run daily route sheets with weekday delivery days, track empty bottle deposits, record operational expenses, and collect weekly or monthly credit with clean thermal and A4 bills. Includes a simple retail dashboard, Route Hisab, expense tracking, and reporting. Stripped of online store, POS, and financial hub clutter.',
    verticals: ['water-delivery'],
    defaultVertical: 'water-delivery',
    recommendedPlanTier: 'professional',
    limitOverrides: {
      max_users: 8,
      max_products: 2000,
    ...
    packaging: {
      mode: 'custom',
      feature_overrides: { ...WATER_COMMERCE_FEATURE_OVERRIDES },
    },
    pricing: {
      price_pkr: 5000,
      price_usd: 18,
      billing: 'monthly',
      badge: 'Water delivery suite',
    },
    marketingPath: '/solutions/water-commerce',
    demoStoreDomain: 'demo-water',
    moduleGroups: [
      {
        id: 'routes',
        title: 'City and area routes',
        body:
          'Customer records with city, delivery area (Karachi DHA, Gulshan, Clifton, and other cities), rider/route, and weekday cadence for domestic and corporate accounts.',
        bullets: [
          'Pakistan city → area knowledge presets',
          'Domestic vs corporate customer types',
          'Delivery days (Daily, Mon Wed Fri, Weekdays…)',
        ],
        status: 'shipped',
      },
      {
        id: 'route-hisab',
        title: 'Daily Route Hisab',
        body:
          'Rider doorstep grid by house/office and route. Week or month totals become invoices and receipts on the standard AR path, with thermal bills and reminders.',
        bullets: [
          'Daily route grid filtered by delivery days',
          'Week/month invoice from delivery totals',
          'Thermal bills plus hub/email/WhatsApp reminders',
        ],
        status: 'shipped',
      },
      {
        ...
        body:
          '19L refill, family packs, PET cases, and empty bottle deposit SKUs with bottle/case units and PK water brands.',
        bullets: [
          'Bottle and case inventory units',
          'Deposit amount on products and customers',
          'Nestlé Pure Life, Aquafina, and local plant brands',
        ],
        status: 'shipped',
      },
      {
        ...
        body:
          'Record daily operational expenses (fuel, rider wages, vehicle maintenance, plant utility) with category breakdowns and lean reporting.',
        bullets: [
          'Fuel & vehicle maintenance category tracking',
          'Log Expense modal integrated in header/dashboard',
          'Clean revenue vs expense reporting',
        ],
        status: 'shipped',
      },
    ],
    faqs: [
      {
        question: 'Is this the same as milk-shop Route Hisab?',
        answer:
          'Same core principle (daily sheet + period bills), tailored for water. water-delivery has dedicated bottle fields, city/area presets, weekday delivery schedules, and expense tracking.',
      },
      {
        question: 'How do I register this suite?',
        answer:
          'Open Industry Plans → Water delivery, or go to /solutions/water-commerce and choose Get this suite. Registration uses package=water-commerce, domain=water-delivery, and the Professional plan (5,000 PKR/mo) with lean packaging applied.',
      },
      {
        question: 'Does Daily Route need a higher plan?',
        answer:
          'No. Daily Route Hisab is fully included in the Professional package (5,000 PKR/mo), along with expense tracking and customer management, stripped of unnecessary POS and store clutter.',
      },
    ],
    competitorNotes: [
      'Spreadsheet route books lose weekday schedules and deposit tracking.',
      'Generic ERPs clutter water distributors with unwanted POS, e-commerce, and financial hub menus.',
      'Tenvo keeps rider sheet, bottle stock, expenses, and collections on one focused tenant at 5,000 PKR/mo.',
    ],
  },
});
