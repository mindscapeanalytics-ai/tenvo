...
import { TYRE_MARKETING_HERO_IMAGE } from '../storefront/tyreStorefront.js';
import { FOOTWEAR_MARKETING_HERO_IMAGE } from '../dataLab/footwearDemoCatalog.js';
import { MILK_SHOP_MARKETING_HERO_IMAGE } from '../dataLab/milkShopDemoCatalog.js';
import { WATER_SHOP_MARKETING_HERO_IMAGE } from '../dataLab/waterShopDemoCatalog.js';
import { ELECTRONICS_MARKETING_HERO_IMAGE } from '../storefront/electronicsStorefront.js';
...
export const CANONICAL_DEMO_HEROES = Object.freeze({
  ...
  'demo-dental': unsplash('1606811841689-23dfddce3e95', 1200),
  'demo-supermarket': SUPERMARKET_HERO,
  'demo-fmcg': FMCG_HERO,
  'demo-retail': unsplash('1556742049-0cfed4f6a45d', 1200),
  'demo-hardware': unsplash('1581092160562-40aa08e78837', 1200),
  'demo-furniture': FURNITURE_MARKETING_HERO_IMAGE,
  'demo-marbles': TILES_MARKETING_HERO_IMAGE,
  'demo-tyre': TYRE_MARKETING_HERO_IMAGE,
  'demo-footwear': FOOTWEAR_MARKETING_HERO_IMAGE,
  'demo-milk': MILK_SHOP_MARKETING_HERO_IMAGE,
  'demo-water': WATER_SHOP_MARKETING_HERO_IMAGE,
  ...
  'demo-electronics': ELECTRONICS_MARKETING_HERO_IMAGE,
...
const GALLERY_OVERRIDES = {
  ...
  'demo-electronics': {
    ...
    marketingName: 'Tenvo Electronics',
    icon: 'monitor',
    backgroundColor: 'bg-gradient-to-br from-blue-700 via-slate-900 to-slate-950',
    glowGradient: '#2563eb',
    glowColor: 'rgba(37, 99, 235, 0.35)',
  },
  'demo-mobile': {
  ...
  'demo-tyre': {
    vertical: 'Tyre retail & bay',
    marketingName: 'Tenvo Tyre Store',
    icon: 'gauge',
    backgroundColor: 'bg-gradient-to-br from-zinc-900 via-red-950 to-black',
    glowGradient: '#CC1532',
    glowColor: 'rgba(204, 21, 50, 0.35)',
  },
  'demo-footwear': {
    vertical: 'Footwear & sneakers',
    marketingName: 'Tenvo Footwear Demo',
    icon: 'footprints',
    backgroundColor: 'bg-gradient-to-br from-amber-200 via-yellow-400 to-zinc-900',
    glowGradient: '#FFDA00',
    glowColor: 'rgba(255, 218, 0, 0.45)',
  },
  'demo-milk': {
    vertical: 'Milk shop & dairy',
    marketingName: 'Tenvo Milk Demo',
    icon: 'milk',
    backgroundColor: 'bg-gradient-to-br from-sky-700 via-cyan-900 to-slate-950',
    glowGradient: '#0ea5e9',
    glowColor: 'rgba(14, 165, 233, 0.35)',
  },
  'demo-water': {
    vertical: 'Water supply & home delivery',
    marketingName: 'Tenvo Water Supply',
    icon: 'droplets',
    backgroundColor: 'bg-gradient-to-br from-sky-600 via-cyan-800 to-slate-950',
    glowGradient: '#0284c7',
