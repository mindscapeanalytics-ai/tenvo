...
const SUPERMARKET_GALLERY_HERO =
  SUPERMARKET_DEFAULT_HERO_SLIDES[0]?.image || unsplash('1578916171728-46686eac8d58', 1920);
...
const GALLERY_OVERRIDES = {
  'demo-textile': {
    ...
    icon: 'layers',
    heroImage: fashionStockImage('1594938298603-c8148c4dae35', 1200),
  ...
  'demo-retail': {
    ...
    icon: 'shopping-bag',
    heroImage: unsplash('1556742049-0cfed4f6a45d', 1200),
  ...
  'demo-dental': {
    ...
    icon: 'stethoscope',
    heroImage: unsplash('1629909613654-28e495c44ad7', 1200),
  ...
  'demo-supermarket': {
    ...
    heroImage: SUPERMARKET_GALLERY_HERO,
  ...
  'demo-marine': {
    ...
    icon: 'ship',
    heroImage: 'https://c11cbcde.delivery.rocketcdn.me/wp-content/uploads/2025/03/Home-topfoto-dwg-trading.jpg',
