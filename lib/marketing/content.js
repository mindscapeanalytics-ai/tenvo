...
export const marketingContent = {
  ...
  hero: {
    ...
    subheadline:
      "Run your brand store, checkout, warehouses, and books as one connected business — not a pile of disconnected apps. Deep Pakistan fit at launch; scaling globally. Built for local compliance and the way teams work from SME to enterprise.",
    primaryCTA: {
      text: "Start Building",
      href: "/register"
    },
  ...
  pakistaniFeatures: {
    ...
    subtitle:
      "Launch depth where local compliance, language, and payments matter most. TENVO is a global product roadmap from Mindscape Analytics LLC.",
    features: [
      {
        icon: "Receipt",
