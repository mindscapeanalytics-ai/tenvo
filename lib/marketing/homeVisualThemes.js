...
import { TENVO_IMG } from './tenvoMarketingImages.js';
...
export const HOME_TRUST_CHIP_THEMES = {
  ...
  'Gym & fitness': 'border-rose-200/90 bg-rose-50/95 text-rose-900',
...
export const HOME_DEMO_SPOTLIGHT = [
  ...
  { ...demo('demo-restaurant'), label: 'Roll Inn' },
];
...
export const HOME_INDUSTRY_SOLUTIONS = [
  ...
  },
  {
    ...
    demoLabel: 'Textile demo',
    accent: { icon: 'bg-emerald-100 text-emerald-700', check: 'text-emerald-600' },
    ...demo('demo-textile'),
    description:
      'Trade pricing, credit limits, and multi-location stock for textile wholesalers and high-volume distributors.',
  ...
  },
  {
    id: 'fitness',
    title: 'Gym & fitness',
    demoLabel: 'Fitness demo',
    accent: { icon: 'bg-rose-100 text-rose-700', check: 'text-rose-600' },
    ...demo('demo-fitness'),
    description:
      'Elevated supplement shop, membership SKUs, Wild Programs hero, and coach booking on a dark branded storefront.',
    bullets: ['Supplements + membership catalog', 'Tenant Calendly booking strip', 'Counter POS and web checkout'],
  },
];
...
export const MARKETING_HONEST_STATS = [
  ...
  { value: '21', label: 'Live demo storefronts' },
  { value: '14-day', label: 'Free trial' },
  { value: '1 hub', label: 'Storefront, POS, and finance' },
];

/**
 * Features page advanced cards (Inventory has a dedicated deep section: FeaturesInventorySection).
 * Prefer TENVO_IMG product screens for ops modules; demo storefront heroes only for channel modules.
 */
export const FEATURE_PAGE_CARDS = [
  {
    ...
    heroImage: TENVO_IMG.inventoryEcosystem,
  ...
  },
  {
    ...
    features: [
      ...
      'Bank reconciliation UI (manual; bank feeds roadmap)',
    ],
    heroImage: TENVO_IMG.pnlStatement,
  ...
  },
  {
    ...
    heroImage: TENVO_IMG.excelEntry,
  ...
  },
  {
    ...
    features: [
      ...
      'Barcode / SKU lookup + camera scan (plan-gated)',
      'Restaurant table-service POS',
      'Kitchen display (Business+, Partial)',
      'Browser thermal receipts (drawer kick in receipt HTML)',
    ],
    demoLabel: 'Restaurant demo',
    accent: {
      card: 'border-orange-200/80 bg-gradient-to-br from-orange-50/70 to-white',
  ...
  },
  {
    ...
    heroImage: TENVO_IMG.advancedDashboard,
...
export const WHY_TENVO_COMPARE = [
  {
    ...
    bullets: [
      'One catalog for web, POS, and invoices',
      'Display stock aligned across hub and storefront',
      'Pakistan tax config (live FBR on roadmap)',
    ],
    icon: 'Store',
    accent: {
      card: 'border-rose-200/80 bg-gradient-to-br from-rose-50/70 to-white',
  ...
  },
  {
    ...
    bullets: [
      'One workspace instead of five app logins',
      'Shared customer record from first order',
      'Industry Plans match your vertical from day one',
    ],
    icon: 'Layers',
    accent: {
      card: 'border-indigo-200/80 bg-gradient-to-br from-indigo-50/70 to-white',
  ...
  },
  {
    ...
    bullets: [
      'Smart restock and operational dashboards',
      'AI analyst drafts for human approval (Business+)',
      'Roadmap: proactive compliance and follow-up agents',
    ],
    icon: 'Sparkles',
    accent: {
      card: 'border-violet-200/80 bg-gradient-to-br from-violet-50/70 to-white',
