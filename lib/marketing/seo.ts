...
export function getRootMarketingMetadata(): Metadata {
  ...
  return {
    ...buildMarketingMetadata({
      ...
      description:
        'TENVO replaces stitched spreadsheets and disconnected apps with inventory, warehouses, POS, branded storefront, orders, and accounting. Pakistan-first depth; global roadmap. Start free at tanvo.store.',
      path: '/',
      keywords: [
        ...DEFAULT_KEYWORDS,
        'www.tanvo.store',
