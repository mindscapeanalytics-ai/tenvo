...
export const DOMAIN_PACKAGE_SOLUTIONS_CONTENT = {
  ...
  'milk-commerce': {
    heroEyebrow: 'Milk shop suite',
    channelsHeading: 'Counter, route hisab, and chill stock',
    channelsLead:
      'Neighborhood doodh shops sell fresh milk by kg at the counter, deliver house routes every morning, and collect weekly or monthly credit without a warehouse ERP.',
    ...
    guideSteps: [
      ...
      },
      {
        ...
        body: 'Start trial with ?package=milk-commerce. Hub lands on milk-shop with restaurant, warehouse chain, and membership chrome stripped.',
