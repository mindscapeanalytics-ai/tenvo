...
export const DOMAIN_PACKAGE_SOLUTIONS_CONTENT = {
  ...
  'water-commerce': {
    ...
    heroLead:
      'City and area rider routes, 19L refill and pack SKUs, domestic and corporate accounts, expense tracking, and week or month credit collect at just PKR 5,000/mo. Built for Pakistani water suppliers, not generic ERP clutter.',
    heroAccent: '#0ea5e9',
    audienceHeading: 'Neighborhood refill plants to multi-city water suppliers',
    audienceLead:
      'Start with Karachi area routes and corporate offices. Grow cities without restaurant, warehouse-chain, POS, or online store modules in the way.',
    audience: [
      {
        title: 'Local water plants and refill shops',
        body: 'Daily Route Hisab, bottle deposits, city/area customer book, expense tracking, and lean retail dashboard on Professional packaging at PKR 5,000/mo.',
        fit: 'Best when paper route books and weekday schedules are the daily pain.',
      },
      {
        title: 'Growing water distributors',
        body: 'More riders and cities, domestic plus corporate cadence, standard AR invoices for weekly or monthly collect, and clean expense reporting.',
    ...
    channelsLead:
      'Daily rider routes, customer billing, and corporate accounts. Same customers, same AR, same expense ledger.',
    modulesHeading: 'Module mix tuned for water delivery operators',
    modulesLead:
      'Only the capabilities a bottled water business needs. Route Hisab, billing, expense tracking, customer management, and reporting. No POS, no online store, no financial hub clutter.',
    highlightFeatures: WATER_COMMERCE_HIGHLIGHTS,
    problemHeading: 'Spreadsheets and generic ERPs slow water suppliers down',
    problemLead:
      'Operators lose hours reconciling rider sheets, deposits, expenses, and weekly credit across neighborhoods.',
    painPoints: [
      {
      ...
      {
        title: 'Wrong software chrome',
        body: 'Generic plans surface restaurant POS, multi-warehouse, online stores, and memberships suppliers never use.',
      },
    ],
    ...
    outcomes: [
      ...
      {
        label: 'Staff learn one OS',
        body: 'Restaurant, POS, and online store chrome stay off. Dashboard opens Water Route, customers, and expenses.',
      },
    ],
    guideHeading: 'Run water delivery in three steps',
    guideLead:
      'Understand city/area routes and Daily Route Hisab, then register with Professional packaging (PKR 5,000/mo) and water-delivery presets.',
    guideSteps: [
      {
        title: 'Know the daily OS',
        body: 'Customers by city and area, Daily Route Hisab for riders, bottle/case tracking, expenses, and week/month credit on standard invoices.',
      },
      {
        title: 'Register the suite',
        body: 'Start trial with water-commerce packaging at PKR 5,000/mo. Hub lands on water-delivery with lean retail chrome.',
    ...
    channelPillars: [
      ...
      },
      {
        ...
        body: 'Log fuel, rider wages, vehicle maintenance, and plant utility with category breakdowns and clean reporting.',
        accent: 'border-emerald-200/80 bg-gradient-to-br from-emerald-50/70 to-white',
        iconClass: 'bg-emerald-600 text-white',
        slideAccent: '#059669',
      },
    ...
    ctaTitle: 'Run your water supply on one clear hub — PKR 5,000/mo',
    ctaSubtitle:
      '14-day trial on Professional modules with water-delivery presets, Daily Route Hisab, expense tracking, and lean packaging.',
  },
};
