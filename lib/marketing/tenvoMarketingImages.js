...
export const TENVO_IMG = {
  ...
  /** Milk shop POS (kg counter + dairy categories) */
  milkPos: `${W}/milk-shop-pos.webp`,
  /** Milk Easy Mode / retail simple hub */
  milkEasy: `${W}/easy-tenvo-milk.webp`,
  /** Milk retail simple dashboard (owner morning OS) */
  milkDashboard: `${W}/milk-retail-simple-dashboard.webp`,
  /** Route Hisab daily sheet */
  ...
  /** Milk bilingual week/month bill (EN + Urdu) */
