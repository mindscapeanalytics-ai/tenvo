...
export const PLATFORM_MODULES = [
  {
    ...
    description:
      'Visual/Busy/Excel entry, location-aware display stock, transfers, Excel import, product images, barcode scan (Starter+), and domain fields. Multi-warehouse, batch, and serial on Professional+ when the domain enables them.',
    status: 'shipped',
    minPlan: 'free',
  ...
  },
  {
    ...
    description:
      'B2B quotations, sales orders, and delivery challans with live stock context. Deeper wholesale packaging lands on Professional+ and Industry Plan suites.',
    status: 'shipped',
    minPlan: 'free',
...
/** Nav mega-menu columns derived from PLATFORM_MODULES (no module id listed twice). */
export const NAV_SOLUTIONS = {
  ...
  growth: ['campaigns', 'crm', 'analytics'],
};
