...
export const INDUSTRY_PLANS_NAV = Object.freeze({
  ...
  hubDescription:
    'Pre-built module mixes, higher limits, and storefront defaults for clothing, pharmacy, auto, showroom, furniture, gym, and milk shop (doodh shop) operators, on top of standard SaaS tiers.',
});
...
const NAV_META = Object.freeze({
  ...
  'milk-commerce': { label: 'Milk shop', icon: 'Milk' },
  'water-commerce': { label: 'Water delivery', icon: 'Droplets' },
});
