...
export const INDUSTRY_PLANS_NAV = Object.freeze({
  ...
  hubDescription:
    'Pre-built module mixes, higher limits, and storefront defaults for clothing, pharmacy, auto, showroom, furniture, gym, and milk shop operators — on top of standard SaaS tiers.',
});
