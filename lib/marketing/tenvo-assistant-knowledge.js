...
export const TENVO_PARENT_COMPANY = {
  ...
  /** WhatsApp same number; wa.me expects digits with country code, no + */
...
- **Learn**: /features, /why-tenvo (vs generic storefront-only or multi-app stacks), /about (mission, team, customer voices at #voices), /case-studies, /integrations, /industries.
