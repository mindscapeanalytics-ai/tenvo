  ...
  try {
    ...
    try {
      result = await client.query(
        `SELECT COALESCE(bs.is_storefront_enabled, true) AS is_storefront_enabled, b.settings, b.is_active
         FROM businesses b
      ...
      if (err?.code === '42P01' || err?.code === '42703') {
        result = await client.query(
          `SELECT true AS is_storefront_enabled, b.settings, b.is_active
           FROM businesses b
           WHERE b.id = $1::uuid
           LIMIT 1`,
          [businessId]
