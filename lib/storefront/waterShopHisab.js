...
export const WATER_HISAB_DEFAULT_COLUMN_HINTS = [
  { id: '19l', label: '19L', match: /19\s*l|dispenser|gallon|jar|can\b/i, preferUnit: 'bottle' },
  { id: '5l', label: '5L', match: /5\s*l/i, preferUnit: 'bottle' },
  { id: '1_5l', label: '1.5L', match: /1\.5\s*l|1500\s*ml/i, preferUnit: 'case' },
...
export const shortWaterHisabProductLabel = shortMilkHisabProductLabel;
