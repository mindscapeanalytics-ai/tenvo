...
/** Curated grocery heroes for marketing + first-paint (stable Unsplash). */
const GROCERY_HERO_PRODUCE = buildUnsplashImageUrl('1542838132-92c53300491e', { w: 1920, q: 85 });
const GROCERY_HERO_AISLE = buildUnsplashImageUrl('1488459716781-31db52582fe9', { w: 1920, q: 85 });
const GROCERY_HERO_SHELVES = buildUnsplashImageUrl('1578916171728-46686eac8d58', { w: 1920, q: 85 });
...
/** Hero carousel — grocery atmosphere first, then archive promo banners */
export const SUPERMARKET_DEFAULT_HERO_SLIDES = [
  {
    eyebrow: 'Fresh this week',
    title: 'Farm-fresh groceries delivered',
    subtitle: 'Produce, dairy, and pantry staples with same-day delivery in your area.',
    image: GROCERY_HERO_PRODUCE,
    ctaLabel: 'Shop fresh',
