...
export const DEAD_IMAGE_HOSTS = new Set([
  ...
  'imraneshop.com',
  'www.imraneshop.com',
  // eatx.pk product/category image CDN is offline (DNS resolves but all paths 404).
  // All Roll Inn demo images are on this host; blocking here triggers the curated
  // food/restaurant Unsplash fallback pool across every storefront component.
  'services.eatx.pk',
]);
