...
/** Dark, high-contrast hero backgrounds — white copy stays readable on every slide. */
export const MARKETPLACE_HERO_IMAGES = {
  primary:
    'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=1920&q=85&auto=format&fit=crop',
  launches:
    'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=1920&q=85&auto=format&fit=crop',
  showroom:
    'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=1920&q=85&auto=format&fit=crop',
};
...
export function getMarketplaceConfig(settings = {}) {
  ...
  return {
    heroPromo: {
      ...
      image:
        raw.heroPromo?.image ||
        MARKETPLACE_HERO_IMAGES.primary,
    },
    coeTicker: {
...
export const MARKETPLACE_POPULAR_BRANDS = [
  ...
  { id: 'kia', name: 'Kia', logoText: 'KIA', image: 'https://images.unsplash.com/photo-1609521263047-f8f205293f24?w=400&q=80&auto=format&fit=crop' },
  { id: 'nissan', name: 'Nissan', logoText: 'N', image: 'https://images.unsplash.com/photo-1590362891991-f776e747a588?w=400&q=80&auto=format&fit=crop' },
];
...
export const MARKETPLACE_ALL_BRANDS = [
  ...
  { id: 'lexus', name: 'Lexus', logoText: 'L', image: 'https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?w=400&q=80&auto=format&fit=crop' },
  ...
  { id: 'mg', name: 'MG', logoText: 'MG', image: 'https://images.unsplash.com/photo-1609521263047-f8f205293f24?w=400&q=80&auto=format&fit=crop' },
...
export const MARKETPLACE_ARTICLES = [
  ...
  },
  {
    ...
    date: 'Feb 2026',
    image: 'https://images.unsplash.com/photo-1609521263047-f8f205293f24?w=800&q=80&auto=format&fit=crop',
    href: '#',
  },
  {
    id: 'tyre-guide',
...
export function getMarketplaceHeroSlides(base, settings = {}) {
  ...
  return [
    ...
    },
    {
      ...
      image: MARKETPLACE_HERO_IMAGES.launches,
    ...
    },
    {
      ...
      title: 'Pre-owned bargains with full history checks',
      subtitle: 'Direct owner, consignment, and dealer listings — filter by body type, fuel, and budget.',
      image: MARKETPLACE_HERO_IMAGES.showroom,
      ctaLabel: 'Browse used cars',
...
export function partitionMarketplaceInventory(products) {
  ...
  const parts = fillProductRailItems(partsRaw, partsRaw, 6, 12);
  const rentalRaw = all.filter((p) => !isPart(p) && isRental(p));
  // Never pad rental/new/used rails with the wrong condition bucket.
  const rental = rentalRaw.slice(0, 8);
