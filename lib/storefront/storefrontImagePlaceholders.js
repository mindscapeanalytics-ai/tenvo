...
import { stableStringHash, getFallbackProductImageUrl } from '@/lib/storefront/productImageFallback';
import { isDeadImageUrl } from '@/lib/storefront/deadImageHosts';

const CARD = { w: 800, q: 80 };
const HERO = { w: 1920, q: 82 };
...
const BODY_TYPE_TILES = {
  ...
  'luxury-sedan': 'https://images.unsplash.com/photo-1555215695-3004980ad54e',
};
...
const AUTO_PARTS_PROMO_FALLBACKS = {
  ...
  'floor-mats': 'https://images.unsplash.com/photo-1581092160562-40aa08e78837',
  'air-fresheners': 'https://images.unsplash.com/photo-1511919884226-fd3cad34687c',
  'engine-oils': 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d',
  'body-kits': 'https://images.unsplash.com/photo-1503376780353-7e6692767b70',
};
...
/**
 * Domain-aware hero carousel fallback — never inject automotive tiles into
 * non-auto verticals when a slide CDN fails (e.g. furniture → cars).
 * @param {string} [variant] HeroCarousel variant
 * @param {string} [seed]
 */
export function resolveHeroCarouselFallback(variant = 'default', seed = '') {
  const v = String(variant || 'default').toLowerCase();
  if (v === 'parts' || v === 'dealership' || v === 'marketplace') {
    return resolveAutomotiveTileImage(seed);
  }

  /** @type {Record<string, string>} */
  const categoryByVariant = {
    furniture: 'furniture',
    pharmacy: 'pharmacy',
    restaurant: 'restaurant-cafe',
    luxury: 'gems-jewellery',
  ...
  const category = categoryByVariant[v] || 'retail-shop';
  return getFallbackProductImageUrl({ name: seed || v, id: seed || v }, category);
}
...
const EDITORIAL_SPOTLIGHT_BY_ID = {
  ...
  wellness: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d',
  'woodin-edit': 'https://images.unsplash.com/photo-1615874959474-d609969a20ed',
  'custom-cakes': 'https://images.unsplash.com/photo-1535141192574-5d4897c13136',
  trade: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837',
...
const EDITORIAL_SPOTLIGHT_BY_CANONICAL = {
  ...
  furniture: 'https://images.unsplash.com/photo-1615874959474-d609969a20ed',
  'ceramics-tiles': 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c',
  pharmacy: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d',
  supermarket: 'https://images.unsplash.com/photo-1542838132-92c53300491e',
  bakery: 'https://images.unsplash.com/photo-1535141192574-5d4897c13136',
  'auto-parts': 'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3',
  'auto-marketplace': 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7',
  'vehicle-dealership': 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7',
  'hardware-sanitary': 'https://images.unsplash.com/photo-1581092160562-40aa08e78837',
  'gym-fitness': 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48',
  'marine-parts': 'https://images.unsplash.com/photo-1544551763-46a013bb70d5',
  'restaurant-cafe': 'https://images.unsplash.com/photo-1504674900247-0877df9cc836',
};
...
const SHOWROOM_BRAND_UNSplash = {
  ...
  kia: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d',
  ...
  haval: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d',
  tesla: 'https://images.unsplash.com/photo-1560958089-b8a1929cea89',
  lexus: 'https://images.unsplash.com/photo-1555215695-3004980ad54e',
  ford: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70',
  ...
  mg: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d',
