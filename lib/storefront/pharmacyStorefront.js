...
/** Demo-only category icons with accurate Lucide icons and seed tile images. */
export const PHARMACY_DEMO_CATEGORY_ICONS = [
  { id: 'pain-relief', label: 'Pain Relief', slug: 'pain-relief', icon: 'pill', image: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=400&q=80&auto=format&fit=crop' },
  { id: 'cough-cold', label: 'Cough & Cold', slug: 'cough-cold', icon: 'thermometer', image: 'https://images.unsplash.com/photo-1585435557343-3b092031a831?w=400&q=80&auto=format&fit=crop' },
  { id: 'antibiotics', label: 'Antibiotics', slug: 'antibiotics', icon: 'syringe', image: 'https://images.unsplash.com/photo-1505751172876-fa1923c5c528?w=400&q=80&auto=format&fit=crop' },
  { id: 'antiseptics', label: 'Antiseptics', slug: 'antiseptics', icon: 'shield-check', image: 'https://images.unsplash.com/photo-1585421514738-01798e348b17?w=400&q=80&auto=format&fit=crop' },
  { id: 'vitamins', label: 'Vitamins', slug: 'vitamins', icon: 'heart-pulse', image: 'https://images.unsplash.com/photo-1631549916768-4119b2e5f926?w=400&q=80&auto=format&fit=crop' },
  { id: 'personal-care', label: 'Personal Care', slug: 'personal-care', icon: 'sparkles', image: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=400&q=80&auto=format&fit=crop' },
  { id: 'skincare', label: 'Skincare', slug: 'skincare', icon: 'sun', image: 'https://images.unsplash.com/photo-1556228720-195a672e8a03?w=400&q=80&auto=format&fit=crop' },
  { id: 'chronic-care', label: 'Chronic Care', slug: 'chronic-care', icon: 'stethoscope', image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=400&q=80&auto=format&fit=crop' },
  { id: 'mother-baby', label: 'Mother & Baby', slug: 'mother-baby', icon: 'baby', image: 'https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?w=400&q=80&auto=format&fit=crop' },
  { id: 'devices', label: 'Devices', slug: 'devices', icon: 'activity', image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=400&q=80&auto=format&fit=crop' },
  { id: 'diabetes-care', label: 'Diabetes Care', slug: 'diabetes-care', icon: 'heart-pulse', image: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=400&q=80&auto=format&fit=crop' },
  { id: 'deals', label: 'Deals', slug: '', hrefSuffix: '?onSale=true', icon: 'tag', image: 'https://images.unsplash.com/photo-1631549916768-4119b2e5f926?w=400&q=80&auto=format&fit=crop' },
];

/** @type {Record<string, string>} */
export const PHARMACY_CATEGORY_ICON_BY_SLUG = {
  'pain-relief': 'pill',
  'cough-cold': 'thermometer',
  'cough-and-cold': 'thermometer',
  antibiotics: 'syringe',
  antiseptics: 'shield-check',
  vitamins: 'heart-pulse',
  'vitamins-and-supplements': 'heart-pulse',
  ...
  devices: 'activity',
  'diabetes-care': 'heart-pulse',
  'first-aid': 'shield-check',
  medicines: 'pill',
  deals: 'tag',
  'hair-care': 'sparkles',
  sleep: 'moon',
...
/** Default category tile images when inventory has no representative product image. */
export const PHARMACY_CATEGORY_SEED_IMAGES = {
  'pain-relief': 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=400&q=80&auto=format&fit=crop',
  'cough-cold': 'https://images.unsplash.com/photo-1585435557343-3b092031a831?w=400&q=80&auto=format&fit=crop',
  antibiotics: 'https://images.unsplash.com/photo-1505751172876-fa1923c5c528?w=400&q=80&auto=format&fit=crop',
  antiseptics: 'https://images.unsplash.com/photo-1585421514738-01798e348b17?w=400&q=80&auto=format&fit=crop',
  vitamins: 'https://images.unsplash.com/photo-1631549916768-4119b2e5f926?w=400&q=80&auto=format&fit=crop',
  'personal-care': 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=400&q=80&auto=format&fit=crop',
  skincare: 'https://images.unsplash.com/photo-1556228720-195a672e8a03?w=400&q=80&auto=format&fit=crop',
  'skin-care': 'https://images.unsplash.com/photo-1556228720-195a672e8a03?w=400&q=80&auto=format&fit=crop',
  'chronic-care': 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=400&q=80&auto=format&fit=crop',
  'mother-baby': 'https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?w=400&q=80&auto=format&fit=crop',
  devices: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=400&q=80&auto=format&fit=crop',
  'diabetes-care': 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=400&q=80&auto=format&fit=crop',
  'first-aid': 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=400&q=80&auto=format&fit=crop',
  medicines: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=400&q=80&auto=format&fit=crop',
  deals: 'https://images.unsplash.com/photo-1631549916768-4119b2e5f926?w=400&q=80&auto=format&fit=crop',
};

function slugifyPharmacyLabel(label) {
  return String(label || '')
    .toLowerCase()
    .trim()
    .replace(/&/g, 'and')
...
/**
 * Map inventory category label/slug to a Lucide icon key for storefront tiles.
 * @param {string} [slug]
 * @param {string} [label]
 */
export function resolvePharmacyCategoryIconKey(slug, label) {
  const normalized = String(slug || slugifyPharmacyLabel(label)).toLowerCase();
  const alias = normalized.replace(/_/g, '-');
  if (PHARMACY_CATEGORY_ICON_BY_SLUG[alias]) {
    return PHARMACY_CATEGORY_ICON_BY_SLUG[alias];
  }
  const labelKey = slugifyPharmacyLabel(label);
  if (PHARMACY_CATEGORY_ICON_BY_SLUG[labelKey]) {
    return PHARMACY_CATEGORY_ICON_BY_SLUG[labelKey];
  }
  return 'package';
}

/**
 * Normalize duplicate skincare aliases and enrich icon/image metadata.
 * @param {object} item
 */
export function enrichPharmacyCategoryItem(item) {
  let slug = String(item.slug || slugifyPharmacyLabel(item.label)).toLowerCase();
  if (slug === 'skin-care') slug = 'skincare';

  const iconKey = String(item.icon || resolvePharmacyCategoryIconKey(slug, item.label))
    .toLowerCase()
    .replace(/_/g, '-');
  const image =
    item.image ||
    PHARMACY_CATEGORY_SEED_IMAGES[slug] ||
    PHARMACY_CATEGORY_SEED_IMAGES[slug.replace(/_/g, '-')] ||
    '';

  const label =
    slug === 'skincare' && /^skin\s*care$/i.test(String(item.label || ''))
      ? 'Skincare'
      : item.label;
...
/**
 * Collapse skincare duplicates and near-duplicate slugs.
 * @param {object[]} items
 */
export function dedupePharmacyCategoryItems(items = []) {
  const seen = new Set();
  const result = [];

  for (const raw of items) {
    const item = enrichPharmacyCategoryItem(raw);
    const key = item.slug || slugifyPharmacyLabel(item.label);
...
const PHARMACY_DEMO_HERO_SLIDES = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1585435557343-3b092031a831?w=1920&q=85&auto=format&fit=crop',
    ctaLabel: 'Upload prescription',
    ctaHref: '/contact?prescription=1',
  },
];

/** Marketing / homepage gallery hero — same asset as `/store/demo-pharmacy` slide 0 */
...
export const PHARMACY_DEMO_CARE_BY_CONDITION = [
  ...
  { id: 'cough', label: 'Cough Relief', slug: 'cough-cold', image: 'https://images.unsplash.com/photo-1585435557343-3b092031a831?w=400&q=80&auto=format&fit=crop' },
  ...
  { id: 'acne', label: 'Acne', slug: 'acne', image: 'https://images.unsplash.com/photo-1556228720-195a672e8a03?w=400&q=80&auto=format&fit=crop' },
...
export function resolvePharmacyContactIntent(searchParams) {
  for (const key of Object.keys(PHARMACY_CONTACT_INTENTS)) {
    if (searchParams.get(key) === '1' || searchParams.get('intent') === key) {
      ...
      const base = { key, ...PHARMACY_CONTACT_INTENTS[key] };
      if (medicine && key === 'prescription') {
        return {
          ...base,
          messagePrefill: `Medicine: ${medicine}\nQuantity needed: \nDosage / instructions from your doctor: `,
        };
      }
      return base;
    }
...
export function resolvePharmacyCategoryIcons(settings, storeBase, ctx = {}) {
  ...
  const mapHref = (item) => ({
    ...item,
    href: item.href || `${productsUrl}${item.hrefSuffix || (item.slug ? `?category=${encodeURIComponent(item.slug)}` : '')}`,
  });

  if (config.categoryIcons) {
    return dedupePharmacyCategoryItems(
      config.categoryIcons.filter((item) => item?.label || item?.slug).map(mapHref)
    );
  }

  const fromDb = dedupePharmacyCategoryItems(
    enrichCategoryNavImages(
      buildCategoryNavItems(ctx.categories, storeBase, { max: 12, includeDeals: true }),
      ctx.products,
  ...
  if (isDemoStoreDomain(ctx.businessDomain)) {
    return PHARMACY_DEMO_CATEGORY_ICONS.map((item) => mapHref(enrichPharmacyCategoryItem(item)));
  }
...
export function resolvePharmacyTrustPillars(settings = {}, businessDomain) {
  const config = getPharmacyConfig(settings, businessDomain);
  const raw = config.trustPillars || PHARMACY_DEFAULT_TRUST_PILLARS;
  return (raw || [])
