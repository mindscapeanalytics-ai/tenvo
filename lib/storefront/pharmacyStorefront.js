...
export const PHARMACY_DEMO_CATEGORY_ICONS = [
  ...
  { id: 'cough-cold', label: 'Cough & Cold', slug: 'cough-cold', icon: 'thermometer', image: 'https://images.unsplash.com/photo-1587854694152-42e3e8f5b672?w=400&q=80&auto=format&fit=crop' },
  { id: 'antibiotics', label: 'Antibiotics', slug: 'antibiotics', icon: 'syringe', image: 'https://images.unsplash.com/photo-1471869640468-c56530f4c4d2?w=400&q=80&auto=format&fit=crop' },
  ...
  { id: 'vitamins', label: 'Vitamins', slug: 'vitamins', icon: 'heart-pulse', image: 'https://images.unsplash.com/photo-1550572017-edd390b6992c?w=400&q=80&auto=format&fit=crop' },
  { id: 'personal-care', label: 'Personal Care', slug: 'personal-care', icon: 'sparkles', image: 'https://images.unsplash.com/photo-1607611568730-7d8a1a2612d4?w=400&q=80&auto=format&fit=crop' },
  ...
  { id: 'mother-baby', label: 'Mother & Baby', slug: 'mother-baby', icon: 'baby', image: 'https://images.unsplash.com/photo-1515488042361-ee00e8170dc0?w=400&q=80&auto=format&fit=crop' },
  { id: 'devices', label: 'Devices', slug: 'devices', icon: 'activity', image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508a118?w=400&q=80&auto=format&fit=crop' },
  ...
  { id: 'deals', label: 'Deals', slug: '', hrefSuffix: '?onSale=true', icon: 'tag', image: 'https://images.unsplash.com/photo-1550572017-edd390b6992c?w=400&q=80&auto=format&fit=crop' },
];
...
export const PHARMACY_CATEGORY_SEED_IMAGES = {
  ...
  'cough-cold': 'https://images.unsplash.com/photo-1587854694152-42e3e8f5b672?w=400&q=80&auto=format&fit=crop',
  antibiotics: 'https://images.unsplash.com/photo-1471869640468-c56530f4c4d2?w=400&q=80&auto=format&fit=crop',
  antiseptics: 'https://images.unsplash.com/photo-1585421514738-01798e348b17?w=400&q=80&auto=format&fit=crop',
  vitamins: 'https://images.unsplash.com/photo-1550572017-edd390b6992c?w=400&q=80&auto=format&fit=crop',
  'personal-care': 'https://images.unsplash.com/photo-1607611568730-7d8a1a2612d4?w=400&q=80&auto=format&fit=crop',
  ...
  'mother-baby': 'https://images.unsplash.com/photo-1515488042361-ee00e8170dc0?w=400&q=80&auto=format&fit=crop',
  devices: 'https://images.unsplash.com/photo-1579684385127-1ef15d508a118?w=400&q=80&auto=format&fit=crop',
  ...
  deals: 'https://images.unsplash.com/photo-1550572017-edd390b6992c?w=400&q=80&auto=format&fit=crop',
};
