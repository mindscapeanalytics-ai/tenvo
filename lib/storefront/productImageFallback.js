...
/**
 * Eatx CDN often returns 404 for .avif via Next image optimizer — prefer .jpg sibling.
 * @param {string | null | undefined} url
 */
export function normalizeStorefrontRemoteImageUrl(url) {
  const raw = String(url || '').trim();
  if (!raw) return '';
  if (raw.includes('services.eatx.pk/') && /\.avif(\?|$)/i.test(raw)) {
    return raw.replace(/\.avif(\?.*)?$/i, '.jpg$1');
  }
  return raw;
}
...
const POOL = {
  ...
  phone: [
    ...
    cardUrl('https://images.unsplash.com/photo-1611186871348-b1ce696e52c9'),
  ...
  tv: [
    ...
    cardUrl('https://images.unsplash.com/photo-1593784991095-a205069470b6'),
  ],
  dairy: [
  ...
  fashion: [
    ...
    cardUrl('https://images.unsplash.com/photo-1483985988355-763728e1935b'),
  ...
  accessoryFashion: [
    cardUrl('https://images.unsplash.com/photo-1590874103328-eac38a683ce7'),
    cardUrl('https://images.unsplash.com/photo-1590874103328-eac38a683ce7'),
  ...
  baby: [
    ...
    cardUrl('https://images.unsplash.com/photo-1618221195710-dd6b41faaea6'),
  ],
  rice: [
  ...
  autoparts: [
    ...
    cardUrl('https://images.unsplash.com/photo-1581092160562-40aa08e78837'),
    cardUrl('https://images.unsplash.com/photo-1492144534655-ae79c964c9d7'),
    cardUrl('https://images.unsplash.com/photo-1486262715619-67b85e0b08d3'),
    cardUrl('https://images.unsplash.com/photo-1486262715619-67b85e0b08d3'),
    cardUrl('https://images.unsplash.com/photo-1558618666-fcd25c85cd64'),
  ],
  tyres: [
    cardUrl('https://images.unsplash.com/photo-1486262715619-67b85e0b08d3'),
    cardUrl('https://images.unsplash.com/photo-1552519507-da3b142c6e3d'),
    cardUrl('https://images.unsplash.com/photo-1492144534655-ae79c964c9d7'),
    cardUrl('https://images.unsplash.com/photo-1503376780353-7e6692767b70'),
  ],
  tools: [
    cardUrl('https://images.unsplash.com/photo-1504148455328-c376907d081c'),
  ...
  plumbing: [
    ...
    cardUrl('https://images.unsplash.com/photo-1581092918056-0c4c3acd3789'),
  ...
  textile: [
    ...
    cardUrl('https://images.unsplash.com/photo-1594938298603-c8148c4dae35'),
    cardUrl('https://images.unsplash.com/photo-1617137968427-85924c800a22'),
    cardUrl('https://images.unsplash.com/photo-1490481651871-ab68de25d43d'),
  ],
  healthcare: [
    cardUrl('https://images.unsplash.com/photo-1582719478250-c89cae4dc85b'),
  ...
  furniture: [
    ...
    cardUrl('https://images.unsplash.com/photo-1618221195710-dd6b41faaea6'),
    cardUrl('https://images.unsplash.com/photo-1505693416388-ac5ce068fe85'),
    cardUrl('https://images.unsplash.com/photo-1631049307264-da0ec9d70304'),
  ],
  tiles: [
    cardUrl('https://images.unsplash.com/photo-1600585154340-be6161a56a0c'),
    cardUrl('https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3'),
    cardUrl('https://images.unsplash.com/photo-1600585154526-990dced4db0d'),
    cardUrl('https://images.unsplash.com/photo-1584622650111-993a426fbf0a'),
    cardUrl('https://images.unsplash.com/photo-1556912173-46c336c7fd55'),
  ],
  jewellery: [
  ...
  salon: [
    cardUrl('https://images.unsplash.com/photo-1604654894610-df63bc536371'),
    cardUrl('https://images.unsplash.com/photo-1522337360788-8b13dee7a37e'),
    cardUrl('https://images.unsplash.com/photo-1519014816548-bf5fe059798b'),
    cardUrl('https://images.unsplash.com/photo-1556228720-195a672e8a03'),
  ],
  pet: [
  ...
  gym: [
    ...
    cardUrl('https://images.unsplash.com/photo-1593095948071-474c5cc2989d'),
    cardUrl('https://images.unsplash.com/photo-1583454110551-21f2fa2afe61'),
    cardUrl('https://images.unsplash.com/photo-1518611012118-696072aa579a'),
  ],
  appliance: [
    cardUrl('https://images.unsplash.com/photo-1571175443880-49e1d25b2bc5'),
    cardUrl('https://images.unsplash.com/photo-1556911220-bff31c812dba'),
    cardUrl('https://images.unsplash.com/photo-1585771724684-38269d6639fd'),
  ],
  carbattery: [
    cardUrl('https://images.unsplash.com/photo-1605559424843-9e4c228bf1c2'),
    cardUrl('https://images.unsplash.com/photo-1486262715619-67b85e0b08d3'),
  ],
  retail: [
...
const NAME_RULES = [
  ...
  { test: (n) => /\b(sofa|chair|table|furniture|mattress|bed|recliner|sectional)\b/.test(n), urls: POOL.furniture },
  { test: (n) => /\b(tile|tiles|marble|granite|porcelain|vitrified|travertine|limestone|onyx|mosaic|ceramic|slab|flooring)\b/.test(n), urls: POOL.tiles },
  { test: (n) => /\b(book|textbook|stationery|geometry|isbn|publisher)\b/.test(n), urls: POOL.books },
  // Supplements / gym before pet+pharmacy so "Optimum Nutrition" never maps to dog photos
  { test: (n) => /\b(whey|protein|creatine|bcaa|pre-?workout|mass gainer|amino|supplement|isolate|casein|gainer|shaker)\b/.test(n), urls: POOL.gym },
  { test: (n) => /\b(gym|fitness|workout|membership|training|dumbbell|kettlebell)\b/.test(n), urls: POOL.gym },
  { test: (n) => /\b(solar|inverter|panel)\b/.test(n), urls: POOL.solar },
  { test: (n) => /\b(pet food|pet nutrition|dog food|cat food|veterinary|grooming|pet|dog|cat)\b/.test(n), urls: POOL.pet },
  ...
  { test: (n) => /\b(tyre|tire|radial|alloy rim|alloy wheel|wheel set|runflat|puncture|alignment|balancing|205\/|215\/|225\/)\b/.test(n), urls: POOL.tyres },
  { test: (n) => /\b(rim|rimsize|loadindex|speedrating)\b/.test(n), urls: POOL.tyres },
...
const VERTICAL_POOLS = {
  ...
  'tyre-shop': [...POOL.tyres],
  'milk-shop': [...POOL.dairy, ...POOL.beverage, ...POOL.bakery],
  ...
  'ceramics-tiles': [...POOL.tiles],
  'vehicle-dealership': [
    cardUrl('https://images.unsplash.com/photo-1492144534655-ae79c964c9d7'),
    cardUrl('https://images.unsplash.com/photo-1503376780353-7e6692767b70'),
    cardUrl('https://images.unsplash.com/photo-1555215695-3004980ad54e'),
    cardUrl('https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8'),
    cardUrl('https://images.unsplash.com/photo-1544636331-e26879cd4d9b'),
  ],
  'auto-marketplace': [
    cardUrl('https://images.unsplash.com/photo-1492144534655-ae79c964c9d7'),
    cardUrl('https://images.unsplash.com/photo-1503376780353-7e6692767b70'),
    cardUrl('https://images.unsplash.com/photo-1552519507-da3b142c6e3d'),
    cardUrl('https://images.unsplash.com/photo-1593941707882-a5bba14938c7'),
    cardUrl('https://images.unsplash.com/photo-1560958089-b8a1929cea89'),
  ],
...
function pickFromPool(urls, seedStr) {
  ...
  // Never return known-dead curated entries (would blank SmartProductImage).
  const live = urls.filter((u) => typeof u === 'string' && u && !isDeadImageUrl(u));
  if (!live.length) return null;
  const idx = stableStringHash(seedStr) % live.length;
  return live[idx];
}
...
export function getFallbackProductImageUrl(product, businessCategory, productCategory = '') {
  ...
  // Prefer the exact business category pool (furniture, ceramics-tiles, …) before
  // the storefront-vertical bucket (often `retail-shop`), so elevated domains
  // never fall through to generic retail/fashion stock.
  const vertical = resolveStorefrontVertical(businessCategory);
  const categoryKey = String(businessCategory || '').toLowerCase().trim();
  const pool =
    VERTICAL_POOLS[categoryKey] ||
    VERTICAL_POOLS[vertical] ||
    VERTICAL_POOLS.default;
...
/**
 * Merchant `image_url` / gallery wins; otherwise name/vertical fallback (https Unsplash).
 * @param {{ name?: string; id?: string | number; image_url?: string | null; images?: unknown } | null | undefined} product
 * @param {string | null | undefined} businessCategory
 * @returns {string}
 */
export function getEffectiveProductImageUrl(product, businessCategory) {
  for (const candidate of normalizeProductImageUrls(product)) {
    const raw = normalizeStorefrontRemoteImageUrl(candidate);
    if (
      raw &&
      !isDeadImageUrl(raw) &&
  ...
  if (fb && !isDeadImageUrl(fb)) {
    return fb.includes('images.unsplash.com/photo-') ? normalizeUnsplashUrl(fb, CARD) : fb;
  }
  const placeholder = getStorefrontProductPlaceholder(businessCategory);
  return placeholder && !isDeadImageUrl(placeholder) ? placeholder : '';
}
