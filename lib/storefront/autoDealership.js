...
export function getDealershipNavLinks(base, ctx = {}) {
  ...
  const aboutEnabled = getAboutStorefrontConfig(ctx.settings, {
    category: ctx.category || 'vehicle-dealership',
  }).enabled;
  return [
    ...
    { id: 'about', label: 'About Us', href: aboutEnabled ? `${base}/about` : `${base}/contact` },
  ];
}
...
export const DEALERSHIP_STORIES = [
  ...
  },
  {
    id: 's4',
    title: 'EV test drive',
    image: 'https://images.unsplash.com/photo-1609521263047-f8f205293f24?w=600&q=80&auto=format&fit=crop',
    href: '#',
  },
  {
    id: 's5',
