...
export function getLuxuryTileImage(variant, label) {
  ...
  const map = {
    ...
    textile: {
      ...
      Cotton: 'https://images.unsplash.com/photo-1558171813-4c088753af8f?w=800&q=80&auto=format&fit=crop',
    ...
    leather: {
      ...
      New: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=800&q=80&auto=format&fit=crop',
