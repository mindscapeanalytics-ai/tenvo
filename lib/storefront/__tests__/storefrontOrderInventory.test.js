...
import {
  ...
  shouldCommitStorefrontInventoryOnCreate,
...
describe('storefrontOrderInventory', () => {
  ...
  it('defers inventory commit for awaiting_payment prepaid orders', () => {
    expect(shouldCommitStorefrontInventoryOnCreate('awaiting_payment')).toBe(false);
    expect(shouldCommitStorefrontInventoryOnCreate('pending')).toBe(true);
    expect(shouldCommitStorefrontInventoryOnCreate('paid')).toBe(true);
  });
