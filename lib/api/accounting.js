...
import {
    ...
    getCashFlowAction,
    getDayBookAction,
    getGlCoverageSnapshotAction,
    reconcilePendingStorefrontGlAction,
...
export const accountingAPI = {
    ...
    async getCashFlow(businessId, startDate, endDate) {
        return await getCashFlowAction(businessId, startDate, endDate);
    },

    async getDayBook(businessId, startDate, endDate) {
        return await getDayBookAction(businessId, startDate, endDate);
    },

    async getGlCoverage(businessId) {
        return await getGlCoverageSnapshotAction(businessId);
    },

    async reconcilePendingStorefrontGl(businessId) {
        return await reconcilePendingStorefrontGlAction(businessId);
    },
