...
export const invoiceAPI = {
    async getAll(businessId, options = {}) {
        const result = await getInvoicesAction(businessId, options);
    ...
    async create(invoiceData, items) {
        ...
        const result = await createInvoiceAction({
            invoiceData: {
                ...
                payment_method: invoiceData.payment_method || invoiceData.paymentMethod || null,
                subtotal: subtotal,
                tax_total: taxTotal,
                total_tax: taxTotal,
                ...
                tax_details: {
                    ...
                    invoice_type: invoiceData.invoiceType || invoiceData.invoice_type || invoiceData.tax_details?.invoice_type || 'retail',
                },
