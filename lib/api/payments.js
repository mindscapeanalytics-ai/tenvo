...
import { getUnifiedPaymentRegisterAction } from '@/lib/actions/standard/agingReports';
...
export const paymentAPI = {
    ...
    /**
     * Delete a payment (requires businessId for tenant isolation)
     */
    async delete(businessId, paymentId) {
        return await deletePaymentAction(businessId, paymentId);
    },
    ...
    /** Unified register: legacy payments + invoice payments (deduped). */
    async getRegister(businessId, filters = {}) {
        return await getUnifiedPaymentRegisterAction(businessId, filters);
    },
};
