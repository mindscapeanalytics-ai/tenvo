...
const PERMISSION_DEFINITIONS = {
    ...
    // ── Restaurant ──
    'restaurant.view_tables': ['waiter', 'cashier', 'manager', 'admin', 'owner'],
    'restaurant.manage_tables': ['manager', 'admin', 'owner'],
    'restaurant.create_order': ['waiter', 'cashier', 'manager', 'admin', 'owner'],
    'restaurant.view_kds': ['waiter', 'manager', 'admin', 'owner'],
