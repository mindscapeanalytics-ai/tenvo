...
export const NAV_PERMISSION_MAP = {
    ...
    orders: { permission: 'orders.view', feature: null },
 ...
 */
export function canAccessTab(role, planTier, navKey) {
    const access = getNavItemAccess(navKey, role, planTier);
...
/** @returns {{ visible: boolean, locked: boolean, requiredPlan: string | null }} */
export function checkAccess(role, planTier, navKey) {
    return getNavItemAccess(navKey, role, planTier);
}
