export const specializedDomains = {
    ...
    /**
     * Marine spare parts & propulsion systems (thrusters, rudder propellers, seals, steering).
     * Isolated from vehicle `auto-parts` and plant `industrial-parts`.
     */
    'marine-parts': {
        name: 'Marine Spare Parts',
        name_ur: 'میرین سپئر پارٹس',
        icon: 'Ship',
        imageUrl: '/industrial_hero_image.png',
        productFields: [
            'Part Number', 'OEM Number', 'Interchange Code',
            'Equipment Type', 'System Condition', 'Vessel Type',
            'Manufacturer', 'Criticality', 'Warranty Period', 'Compatible Models',
        ],
        taxCategories: ['VAT 21%', 'VAT 9%', 'Zero Rated', 'Export'],
        units: ['pcs', 'set', 'kit', 'pair', 'box'],
        alternateUnits: { set: 'pcs', kit: 'pcs', box: 'pcs', pair: 'pcs' },
        defaultTax: 21,
        fieldConfig: {
            partnumber: { label: 'Part Number', type: 'text', placeholder: 'Internal / catalogue number', required: true },
            oemnumber: { label: 'OEM Number', type: 'text', placeholder: 'Original equipment manufacturer number', required: true },
            interchangecode: { label: 'Interchange / Cross-ref', type: 'text', placeholder: 'Alternate OEM / maker part numbers', required: false },
            equipmenttype: {
                label: 'Equipment Type',
                type: 'select',
                options: [
            ...
            systemcondition: {
                ...
                type: 'select',
                options: ['new', 'used', 'refurbished', 'spare'],
                required: true,
            },
            vesseltype: {
                label: 'Vessel Type',
                type: 'select',
                options: ['Workboat', 'Tug', 'Ferry', 'Tanker', 'Cargo', 'Yacht', 'Naval', 'Other'],
                required: false,
            },
            manufacturer: {
                ...
                type: 'select',
                options: [
                    'Wärtsilä', 'Schottel', 'Kongsberg', 'Veth', 'ZF',
                    'Neuver / Tenfjord', 'Frydenbø', 'DWG', 'Generic / Aftermarket', 'Other',
                ],
                required: false,
            },
            criticality: {
                ...
                type: 'select',
                options: ['A - Critical', 'B - Important', 'C - General'],
                required: false,
            },
            warrantyperiod: {
                label: 'Warranty Period',
                type: 'select',
                options: ['No Warranty', '3 Months', '6 Months', '1 Year', '2 Years', 'OEM Standard'],
                required: false,
            },
            compatiblemodels: {
                label: 'Compatible Models',
                type: 'text',
                placeholder: 'e.g. SRP 1215 | TT 1650 | Series cross-refs',
                required: false,
            },
        },
        customerFields: ['Vessel Name', 'IMO Number', 'Fleet / Operator', 'Port of Call', 'Payment Terms'],
        vendorFields: ['OEM Authorization', 'Lead Time (weeks)', 'Minimum Order Value', 'Export Docs'],
        inventoryFeatures: [
            'Part & OEM number lookup', 'Equipment-type fitment', 'New / used / refurbished stock',
            'Serial tracking for complete units', 'Batch / lot for seals & kits', 'Multi-warehouse & yard bins',
            'Criticality (ABC) stocking', 'Quotation & RFQ lines', 'Export / VAT handling',
            'Stock valuation (FIFO / Average)', 'Slow-mover & critical fill alerts',
        ],
        reports: [
            'Parts sales by equipment type', 'Critical A-item fill rate', 'New vs used margin',
            'Supplier lead-time variance', 'Stock valuation', 'Vessel / fleet consumption',
        ],
        paymentTerms: ['Advance', 'Cash', 'Credit 15 Days', 'Credit 30 Days', 'LC', 'CAD'],
        stockValuationMethod: 'FIFO',
        reorderEnabled: true,
        multiLocationEnabled: true,
        serialTrackingEnabled: true,
        ...
        setupTemplate: {
            ...
            suggestedProducts: [
                {
                    name: 'Hydraulic Retractable Rudder Propeller SRP-class',
                    unit: 'set',
                    category: 'Rudder Propellers',
                    startingStock: 2,
                    defaultPrice: 185000,
                    description: 'Complete hydraulic retractable rudder propeller unit for workboats and tugs',
                },
                {
                ...
                {
                    name: 'Sterntube Compact Seal Set',
                    unit: 'set',
    ...
    'tyre-shop': {
        ...
        productFields: [
            'Tyre Size', 'Load Index', 'Speed Rating', 'DOT Week', 'Rim Size', 'Run-flat', 'Sourcing', 'Brand',
        ],
        ...
        fieldConfig: {
            ...
            brand: { label: 'Brand', type: 'text', placeholder: 'e.g. GTR, Michelin', required: false },
        },
        ...
        inventoryFeatures: [
            ...
            'Multi-location godowns', 'Purchase by container / mixed loads', 'Local vs imported sourcing',
        ],
        reports: [
            'Sales by size & brand', 'DOT age / oldest batch', 'Fitting labour vs tyre margin',
            'Slow-moving sizes', 'Stock valuation', 'Purchase vs retail GP', 'Local vs imported mix',
        ],
            ...
            suggestedProducts: [
                {
                    ...
                    startingStock: 24,
                    defaultPrice: 14500,
                    description: 'Local economy touring tyre for compact sedans',
                },
                {
                    ...
                    startingStock: 12,
                    defaultPrice: 52000,
                    description: 'Imported premium SUV touring tyre',
                },
                {
                    ...
                    startingStock: 999,
                    defaultPrice: 2500,
                    description: 'Mount, balance, and disposal labour bundle',
                },
            ],
        },
    },
