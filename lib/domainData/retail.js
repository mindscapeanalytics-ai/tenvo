export const retailDomains = {
    ...
    'milk-shop': {
        icon: 'Milk',
        imageUrl: '/retail_hero_image.png',
        productFields: ['Fat %', 'Source', 'Batch Number', 'Expiry Date'],
        taxCategories: ['Exempt', 'Sales Tax 0%', 'Sales Tax 17%'],
        units: ['kg', 'litre', 'pack', 'pcs', 'dozen'],
        alternateUnits: { pack: 'pcs', dozen: 'pcs', litre: 'kg' },
        defaultTax: 0,
        fieldConfig: {
            fatpercent: { label: 'Fat %', type: 'number', placeholder: 'e.g. 3.5', required: false },
            source: {
                label: 'Source',
                type: 'select',
                options: ['Farm / Collector', 'Brand', 'Own Dairy', 'Mixed'],
                required: false,
            },
            batchnumber: { label: 'Batch Number', type: 'text', placeholder: 'e.g. BATCH-2024-001', required: false },
            expirydate: { label: 'Expiry / Best Before', type: 'date', required: false },
        },
        customerFields: ['Delivery Route', 'Daily Milk Preference', 'Preferred Payment Method'],
        vendorFields: ['Milk Supplier', 'Quality Certificate', 'Payment Cycle'],
        inventoryFeatures: [
            'Expiry Tracking', 'FEFO (First Expiry First Out)', 'Batch Tracking',
            'Weight-based Sales (kg)', 'Chilled Stock Alerts', 'Barcode Scanning',
            'Reorder Points', 'Multi-Location Inventory', 'FBR Compliance',
        ],
        reports: [
            'Daily Milk Sales', 'Expiry Alerts', 'Category Sales', 'Stock Summary',
