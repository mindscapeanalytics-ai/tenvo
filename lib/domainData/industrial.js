export const industrialDomains = {
    ...
    'ceramics-tiles': {
        icon: 'Grid',
        imageUrl: '/industrial_hero_image.png',
        name: 'Tiles, Marble & Stone',
        productFields: [
            'Design/Pattern', 'Tone/Shade ID', 'Size (mm)', 'Finish', 'Material Type',
            'Collection', 'Space Use', 'Thickness (mm)', 'Pallet Number', 'Origin'
        ],
        taxCategories: ['Sales Tax 17%', 'WHT 2%', 'Zero Rated (Export)'],
        units: ['pcs', 'sqm', 'sqft', 'box', 'slab', 'pallet'],
        alternateUnits: { box: 'pcs', sqm: 'sqft', slab: 'sqft', pallet: 'box' },
        defaultTax: 17,
        fieldConfig: {
            designpattern: { label: 'Design/Pattern', type: 'text', placeholder: 'e.g. Carrara vein, Wood oak', required: true },
            toneshadeid: { label: 'Tone/Shade ID', type: 'text', placeholder: 'e.g. B-12', required: true },
            sizemm: { label: 'Size (mm)', type: 'text', placeholder: 'e.g. 600x600 / 800x1600', required: true },
            finish: {
                label: 'Surface Finish',
                type: 'select',
                options: [
                    'Polished', 'Matte', 'Rustic', 'Lappato', 'Carving Ink', 'Mica',
                    'Anti-Slip', 'Honed', 'Flamed', 'Sandblasted', 'Leather', 'Bush Hammered'
                ],
                required: true
            },
            materialtype: {
                ...
                type: 'select',
                options: [
                    'Ceramic', 'Porcelain', 'Vitrified', 'Marble', 'Granite', 'Onyx',
                    'Travertine', 'Limestone', 'Sandstone', 'Quartzite', 'Mosaic', 'Adhesive'
                ],
                required: true
            },
            collection: { label: 'Collection', type: 'text', placeholder: 'e.g. Elite, Modish, Signature', required: false },
            spaceuse: {
                label: 'Space Use',
                type: 'select',
                options: ['Living Room', 'Bedroom', 'Bathroom', 'Kitchen', 'Dining Room', 'Outdoor', 'Commercial', 'Facade'],
                required: false
            },
            thicknessmm: { label: 'Thickness (mm)', type: 'number', placeholder: 'e.g. 9 / 20', required: false },
            palletnumber: { label: 'Pallet / Lot Number', type: 'text', placeholder: 'e.g. P-450', required: false },
            origin: {
                label: 'Origin',
                type: 'select',
                options: ['Local', 'Imported', 'Export Grade', 'Italy', 'Spain', 'Turkey', 'China', 'Pakistan'],
                required: false
            }
        },
        customerFields: ['Project Type', 'Contractor Name', 'Delivery Site', 'Architect / Designer', 'Emporium Preference'],
        vendorFields: ['Manufacturer', 'Quality Grade', 'Bulk Discount', 'Factory Lot', 'Export Certificate'],
        inventoryFeatures: [
            ...
            'Slab Inventory', 'Collection & Size Matrix', 'Space-wise Catalog', 'Export Lot Tracking'
        ],
        reports: [
            ...
            'Damage Analysis', 'Agent Performance', 'Stock Ledger', 'Collection Sell-through',
            'Material Mix (Tile vs Stone)', 'Export vs Local Sales'
        ],
        paymentTerms: ['Cash', 'Bank Transfer', 'Credit 30 Days', 'Cheque', 'LC (Export)', 'Advance'],
        stockValuationMethod: 'Average',
        reorderEnabled: true,
        multiLocationEnabled: true,
        serialTrackingEnabled: false,
        ...
        setupTemplate: {
            categories: [
                'Floor Tiles', 'Wall Tiles', 'Outdoor Tiles', 'Bathroom Tiles', 'Kitchen Tiles',
                'Marble', 'Granite', 'Onyx', 'Travertine', 'Limestone',
                'Mosaic Tiles', 'Building & Installation', 'Adhesives', 'Grout & Spacers'
            ],
            suggestedProducts: [
                { name: 'Porcelain Floor Tile 60x60 Polished', unit: 'box', category: 'Floor Tiles', startingStock: 120, defaultPrice: 5200, description: 'Real porcelain floor tile, polished finish' },
                { name: 'Matte Wall Tile 30x60', unit: 'box', category: 'Wall Tiles', startingStock: 150, defaultPrice: 3800, description: 'Elegant matte ceramic wall tile' },
                { name: 'Carrara White Marble Slab', unit: 'sqft', category: 'Marble', startingStock: 800, defaultPrice: 450, description: 'Imported white marble slab for counters and flooring' },
                { name: 'Black Galaxy Granite', unit: 'sqft', category: 'Granite', startingStock: 600, defaultPrice: 380, description: 'Durable speckled granite for kitchens and facades' },
