...
export const pakistaniBrands = {
  ...
  footwear: [
    ...
    'ASICS', 'Brooks', 'Saucony', 'Under Armour', 'Hummel', 'On', 'Jordan',
  ],
  ...
  electronics: [
    ...
    'YOLO', 'Samsung', 'LG', 'Sony', 'Panasonic', 'Philips'
  ],
  ...
  // Milk shop / dairy retail (PK doodh shop + UHT brands)
  dairy: [
    "Olper's",
    'Nurpur',
    'Nestlé Pakistan',
  ...
  // Bottled / mineral water delivery (PK plants + national + Gulf imports)
  water: [
    'Nestlé Pure Life',
    'Aquafina',
    'Kinley',
  ...
  // Tyre retail — local manufacturers + commonly imported brands
  tyres: [
    'GTR',
    'General Tyre',
    'Michelin',
  ...
  // Auto parts (shared spare-parts verticals)
  autoparts: [
    'Bosch',
    'Denso',
    'NGK',
  ...
  // Tiles, marble, ceramics & building finishes
  construction: [
    'STILE (Shabbir Tiles)', 'Master Tiles', 'Emco Industries', 'Forte Ceramics',
    'Sonex Ceramics', 'Karam Ceramics', 'Frontier Ceramics', 'Swat Ceramics',
    'SK Stones', 'SMB Marble', 'Pakistani Marble', 'Indus Gold Marble',
    'Imported Porcelain', 'RAK Ceramics', 'Kajaria', 'Asian Granito',
    'Local Granite', 'Local Onyx', 'Travertine Import', 'Building Materials Local'
  ],
