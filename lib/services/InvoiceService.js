...
export const InvoiceService = {
    ...
    async voidInvoice(businessId, invoiceId, userId, txClient = null) {
        ...
        try {
            ...
            await client.query(`DELETE FROM gl_entries WHERE (reference_type = 'invoice' OR reference_type = 'invoices') AND reference_id = $1`, [invoiceId]);

            // 4. Update Header
            await client.query(`UPDATE invoices SET status = 'voided', is_deleted = true, updated_at = NOW() WHERE id = $1`, [invoiceId]);
