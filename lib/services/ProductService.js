...
export const ProductService = {
    ...
    async updateProduct(id, businessId, updates, tx = db) {
        ...
        if (data.expiry_date || data.expiryDate) data.expiry_date = new Date(data.expiry_date || data.expiryDate);
        if (data.manufacturing_date || data.manufacturingDate) data.manufacturing_date = new Date(data.manufacturing_date || data.manufacturingDate);
