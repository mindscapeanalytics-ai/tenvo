    ...
    async createJournalEntry(params, txClient = null) {
        ...
        try {
            ...
            const journalRes = await client.query(`
                INSERT INTO journal_entries (business_id, journal_number, transaction_date, description, reference_type, reference_id, created_by, status)
        ...
        try {
            ...
            switch (type) {
                case 'sale': {
                    ...
                    const saleNet    = Number(data.netAmount   ?? (saleTotal - saleTax));
