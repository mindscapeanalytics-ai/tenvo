/**
 * @deprecated This module is not wired into the app. TENVO uses **`@/lib/rbac/permissions`** plus
 * **`withGuard`** / **`usePermissions`** for real access control (`inventory.view`, `sales.record_payment`, etc.).
 * Do not add new imports from this file — it uses a legacy permission string namespace (`view_inventory`, …)
 * that does not match production RBAC. Kept temporarily so old docs / specs that reference this path do not 404.
 *
 * @see `lib/rbac/permissions.js` — canonical matrix and `hasPermission(role, permission)`.
 * @see `lib/rbac/serverGuard.js` — server-side enforcement.
 */
