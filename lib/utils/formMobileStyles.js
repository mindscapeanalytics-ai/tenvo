...
export const MOBILE_INPUT_CLASS = 'h-9 rounded-lg border-gray-200 text-sm';
export const MOBILE_LABEL_CLASS = 'text-[11px] font-semibold text-slate-600';
export const MOBILE_SELECT_TRIGGER = 'h-9 rounded-lg text-sm';
...
export const MOBILE_BTN_PRIMARY = 'h-9 rounded-xl px-4 text-xs font-bold sm:h-10 sm:text-sm';
