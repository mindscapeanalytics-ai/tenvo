...
export const MOBILE_TAB_LIST = 'mb-3 flex h-auto min-h-9 w-full flex-wrap justify-start gap-1 rounded-lg bg-gray-100/80 p-0.5 sm:grid sm:grid-cols-3 sm:overflow-visible';
