...
export const POS_SHELL_FOOTER =
    'shrink-0 z-10 border-t bg-inherit shadow-[0_-6px_20px_-8px_rgba(15,23,42,0.08)] pb-[env(safe-area-inset-bottom)]';

/** Full-width F1–F9 power-till dock (pinned in-flow footer, all POS domains). */
export const POS_HOTKEY_DOCK =
    'shrink-0 z-20 w-full border-t border-slate-200/90 bg-white ' +
    'shadow-[0_-6px_20px_-8px_rgba(15,23,42,0.10)] ' +
