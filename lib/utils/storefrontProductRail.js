...
/** Fixed slide width for marquee rails — matches the 6-col grid column math at each breakpoint. */
export const STORE_PRODUCT_RAIL_SLIDE_CLASS =
  'w-[calc((100%-0.75rem)/2)] shrink-0 sm:w-[calc((100%-2rem)/3)] lg:w-[calc((100%-5*0.875rem)/6)]';

/** Marquee slides use fixed widths so every card is identical regardless of content. */
export const STORE_PRODUCT_RAIL_MARQUEE_SLIDE_CLASS =
  'w-[152px] shrink-0 sm:w-[168px] md:w-[180px] lg:w-[200px] xl:w-[210px]';
