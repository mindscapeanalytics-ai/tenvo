...
export const CN_BRAND_CATALOG = {
  ...
  tyres: [
    'Triangle', 'Linglong', 'Sailun', 'Giti', 'Double Coin', 'Chaoyang',
    'Westlake', 'Goodride', 'Maxxis', 'Hankook', 'Michelin', 'Bridgestone',
  ],
  paint: ['Nippon Paint China', 'SKSHU', 'Dulux China', 'BASF Coatings'],
  construction: [
    'CNBM', 'Anhui Conch', 'China Resources Cement', 'Orient Cement',
    'Dongpeng', 'Marco Polo Ceramics', 'Newpearl', 'Monalisa',
    'Imported Porcelain China', 'Xiamen Stone', 'Foshan Ceramics'
  ],
