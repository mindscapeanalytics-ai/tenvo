...
export const AE_BRAND_CATALOG = {
  ...
  tyres: [
    ...
    'Yokohama', 'Hankook', 'Dunlop', 'Maxxis', 'Nexen', 'Toyo', 'Falken',
  ],
  paint: ['Jotun', 'National Paints', 'Dulux', 'Berger', 'Caparol'],
  construction: [
    'Emirates Steel', 'Gulf Cement', 'Union Cement', 'RAK Ceramics',
    'Saudi Ceramics', 'Al Anwar Ceramic', 'Porcelanosa', 'Marazzi',
    'Imported Marble UAE', 'Onyx Dubai', 'Granite Trading'
  ],
