...
export const US_BRAND_CATALOG = {
  ...
  footwear: ['Nike', 'Adidas', 'New Balance', 'Skechers', 'Timberland', 'Crocs', 'Birkenstock', 'Puma', 'Converse', 'Jordan', 'Vans', 'Reebok', 'ASICS', 'Brooks'],
  electronics: [
  ...
  tyres: [
    'Goodyear', 'Michelin', 'Bridgestone', 'Continental', 'Pirelli',
    'Yokohama', 'Hankook', 'Firestone', 'Cooper', 'BFGoodrich', 'Toyo', 'Falken',
  ],
  paint: ['Sherwin-Williams', 'Benjamin Moore', 'Behr', 'PPG', 'Valspar'],
  construction: [
    'USG', 'CertainTeed', 'Georgia-Pacific', 'Quikrete', 'Owens Corning',
    'Daltile', 'Mohawk Flooring', 'Arizona Tile', 'MSI Surfaces',
    'Caesarstone', 'Cambria', 'Natural Stone US'
  ],
