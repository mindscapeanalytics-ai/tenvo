...
export const REGISTRATION_RICH_CATALOG_VERTICALS = new Set([
  ...
  'restaurant-cafe',
  'ceramics-tiles',
  /** Elevated jewellery storefront needs live inventory on day one (not category shells only). */
  'gems-jewellery',
  /** Elevated tyre retail + bay needs sized catalog on day one. */
  'tyre-shop',
  /** Elevated footwear / shoe retail needs sized catalog on day one. */
  'leather-footwear',
  /** Neighborhood milk shop — kg fresh milk + dairy seed on day one. */
  'milk-shop',
  /** Bottled water plant / rider delivery — 19L cycle + dispensers on day one. */
  'water-delivery',
  /** Elevated electronics appliances + gadgets store. */
  'electronics-goods',
]);
...
export const PACKAGE_RICH_CATALOG_VERTICALS = new Map([
  ...
  ['water-commerce', new Set(['water-delivery'])],
  ['milk-commerce', new Set(['milk-shop'])],
]);
