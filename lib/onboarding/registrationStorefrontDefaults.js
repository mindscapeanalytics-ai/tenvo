...
import { isFootwearElevatedStore, buildDefaultFootwearStorefrontSeed } from '../storefront/footwearStorefront.js';
import { isElectronicsElevatedStore, buildDefaultElectronicsStorefrontSeed } from '../storefront/electronicsStorefront.js';
...
export function resolveRegistrationStorefrontDefaults({
  ...
  const tyreStorefrontSeed = isTyreElevatedStore(canonical)
    ...
    : {};
  const footwearStorefrontSeed = isFootwearElevatedStore(canonical)
    ? buildDefaultFootwearStorefrontSeed(canonical)
    : {};
  const electronicsStorefrontSeed = isElectronicsElevatedStore(canonical)
    ? buildDefaultElectronicsStorefrontSeed(canonical)
    : {};
  ...
  return withMediaAndSeo(pickBusinessMediaAndSeo(profile), {
    ...
    storefrontExtras: {
      ...
      storefront: {
        ...
        ...tilesStorefrontSeed,
        ...tyreStorefrontSeed,
        ...footwearStorefrontSeed,
        ...electronicsStorefrontSeed,
      },
    },
  });
}
