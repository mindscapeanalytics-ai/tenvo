...
export function getRegistrationVerticalFeatureOverrides(domainKey) {
  ...
  // STRICT ENFORCEMENT: Domain vertical knowledge no longer automatically injects
  // feature overrides (e.g. batch_tracking) that bypass plan tier restrictions.
  // Businesses will get exactly the features of their selected plan or domain package SKU.
