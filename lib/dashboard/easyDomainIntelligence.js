  ...
  const map = {
    ...
    operations:
      profile.category === 'milk-shop'
        ? 'Counter POS for walk-ins; Route Hisab for house credit. Chill FEFO stays on Stock.'
...
export function buildVerticalInsightCards(profile, metrics = {}) {
  ...
  if (profile.category === 'milk-shop') {
    ...
    cards.push({
      ...
      text: 'Walk-in kg sales stay on POS. Doorstep houses stay on Route Hisab so credit and chill stock stay clear.',
      tone: 'cyan',
      actionTab: 'pos',
    });
  }
