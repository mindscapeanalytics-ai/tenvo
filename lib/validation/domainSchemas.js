...
export const TextileFashionSchema = z
    .object({
        ...
        articleno: z.union([z.string(), z.number()]).optional(),
        designno: z.union([z.string(), z.number()]).optional(),
...
/** Footwear / shoe retail domain_data (matches leather-footwear fieldConfig). */
export const FootwearSchema = z
    .object({
...
export const DomainSchemaResolver = {
    ...
    'leather-footwear': FootwearSchema,
