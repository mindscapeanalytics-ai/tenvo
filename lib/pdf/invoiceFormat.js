...
export function resolveBusinessRegistrationLines(business = {}, settingsParsed = {}) {
  ...
  const country = String(business.country || 'Pakistan').toLowerCase();
  const standards = getRegionalStandards(business.country || 'Pakistan');
  ...
  if (country.includes('pakistan') || standards.countryCode === 'PK') {
